...
describe("mock OpenAI response markers", () => {
  ...
  it("echoes dynamic OpenAgent E2E and update serving markers", async () => {
    await withMockServer(mockOpenAiPath, {}, async (baseUrl) => {
      ...
      const cases = [
        ...
        })),
        {
          ...
          prompt: `This is an OpenAgent update serving check. Do not use tools. Reply with exactly: ${servingMarker}`,
        },
      ];
