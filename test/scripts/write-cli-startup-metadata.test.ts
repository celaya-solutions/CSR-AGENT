...
describe("write-cli-startup-metadata", () => {
  ...
  it("regenerates help when build version or commit changes", async () => {
    ...
    expect(readFileSync(outputPath, "utf8")).toContain("OpenAgent 2026.7.2 (aaaaaaa)");
    ...
    expect(readFileSync(outputPath, "utf8")).toContain("OpenAgent 2026.7.2 (bbbbbbb)");
    ...
    expect(written.subcommandHelpText.models).toContain("OpenAgent 2026.7.3 (bbbbbbb)");
  });
});
