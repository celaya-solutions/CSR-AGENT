...
const MANUAL_OVERRIDE_REASON =
  "OpenAgent Release Publish run 12345 approved token release for v2026.7.1-beta.3";
    ...
    expect(() =>
      verifyFixture(fixture, {
        manualOverrideReason:
          "OpenAgent Release Publish run 12345 approved token release for v2026.7.1-beta.4",
      }),
