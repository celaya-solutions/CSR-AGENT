...
# build the runner/functional images with the prepared OpenAgent package tarball.
...
docker_e2e_test_state_entrypoint() {
  ...
  echo "OpenAgent test-state entrypoint not found under $ROOT_DIR/scripts/lib" >&2
  return 1
}
