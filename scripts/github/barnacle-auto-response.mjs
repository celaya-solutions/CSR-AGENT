...
const rules = [
  ...
  },
  {
    ...
    close: true,
    message:
      "Closing this because it looks like a false positive or reclassification-only report rather than an actionable OpenAgent bug. If this is still a real issue, please open a fresh report with concrete reproduction steps and current-version details.",
  },
  {
    label: "r: no-ci-pr",
    close: true,
  ...
  },
  {
    ...
    message:
      "BlueBubbles is deprecated and no longer ships as a bundled OpenAgent channel. Use iMessage via `imsg` instead: https://docs.openclaw.ai/channels/imessage. If this needs to stay BlueBubbles-backed, publish it as a third-party plugin on ClawHub instead of adding it back to core.",
  },
  {
    label: "r: moltbook",
    close: true,
    ...
    message:
      "OpenAgent is not affiliated with Moltbook, and issues related to Moltbook should not be submitted here.",
  },
];
...
export const managedLabelSpecs = {
  ...
  "r: moltbook": {
    color: "B60205",
    description: "Auto-close and lock: Moltbook is off-topic for OpenAgent.",
  },
  "r: spam": {
    color: "B60205",
...
const candidateActionRules = [
  ...
  },
  {
    ...
    close: true,
    message:
      "Closing this PR because the docs-only change is too low-signal for the core repo. Please reopen or resubmit with a concrete OpenAgent docs gap and linked context.",
  },
  {
  ...
  },
  {
    ...
    close: true,
    message:
      "Closing this PR because the template is mostly blank and does not describe a concrete OpenAgent problem, fix, or test plan. Please reopen or resubmit with the missing context filled in.",
  },
];
