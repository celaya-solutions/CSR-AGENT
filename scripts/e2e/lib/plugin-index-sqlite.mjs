...
export function writePluginInstallIndexForE2E(index, options = {}) {
  ...
  try {
    ...
    if (storageMode === "current") {
      ...
      const persisted = {
        ...
        index: {
          ...
          warning:
            index.warning ??
            "DO NOT EDIT. This row is generated by OpenAgent plugin registry commands.",
    ...
    db.prepare(
      ...
      index.warning ?? "DO NOT EDIT. This row is generated by OpenAgent plugin registry commands.",
      now,
    );
  } finally {
    db.close();
