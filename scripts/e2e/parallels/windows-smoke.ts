...
// Windows Smoke script supports OpenAgent repository automation.
...
const windowsPortableGitPathScript = `$portableGit = Join-Path (Join-Path (Join-Path $env:LOCALAPPDATA 'OpenAgent\\deps') 'portable-git') ''
