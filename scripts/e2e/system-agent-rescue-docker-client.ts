// OpenAgent rescue-message Docker harness.
...
async function main() {
  ...
  assert(
    revokedApproval === "No pending OpenAgent rescue change is waiting for approval.",
  ...
  console.log("OpenAgent rescue Docker E2E passed");
}
