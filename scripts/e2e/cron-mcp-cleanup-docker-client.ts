// Cron Mcp Cleanup Docker Client script supports OpenAgent repository automation.
...
import type { GatewayRpcClient } from "../../test/e2e/mcp/mcp-channels.fixture.ts";
import { readPositiveIntEnv } from "./lib/env-limits.mjs";

const execFileAsync = promisify(execFile);
const PROBE_PID_WAIT_MS = readCronMcpCleanupProbePidWaitMs();
type McpChannelsHarness = typeof import("../../test/e2e/mcp/mcp-channels.fixture.ts");
...
async function loadMcpChannelsHarness(): Promise<McpChannelsHarness> {
  mcpChannelsHarness ??= await import("../../test/e2e/mcp/mcp-channels.fixture.ts");
