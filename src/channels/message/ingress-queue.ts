 ...
 *
 * Stores, claims, completes, and tombstones inbound channel events in Zero to Agent state.
 */
...
/** Creates a durable channel/account-scoped ingress queue backed by the Zero to Agent state database. */
