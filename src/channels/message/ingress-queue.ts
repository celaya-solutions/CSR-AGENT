 ...
 *
 * Stores, claims, completes, and tombstones inbound channel events in OpenAgent state.
 */
...
/** Creates a durable channel/account-scoped ingress queue backed by the OpenAgent state database. */
