    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openagent directory self --channel slack", "Show the connected account identity."],
          [
            'openagent directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openagent directory groups list --channel discord", "List available groups/channels."],
          [
