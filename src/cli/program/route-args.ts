...
/** Parse `openagent health` flags for the route-first status family. */
...
/** Parse `openagent status` flags without registering the full command tree. */
...
/** Parse `openagent gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse machine-readable `openagent gateway health` calls for route-first execution. */
...
/** Parse `openagent sessions` filters for JSON/list route execution. */
...
/** Parse `openagent agents list` display switches for route-first execution. */
...
/** Parse `openagent config get <path>` while preserving root option handling. */
...
/** Parse `openagent config unset <path>` and its mutation guard flags. */
...
/** Parse `openagent models list` filters for the lightweight model catalog route. */
...
/** Parse both parent aliases and `openagent models status` through one status owner. */
...
/** Parse `openagent channels list` display flags for the route-first list path. */
...
/** Parse `openagent channels status` probe flags without full CLI registration. */
...
/** Parse `openagent plugins list` flags for the metadata-only inventory path. */
...
/** Parse both `openagent tasks --json` and `openagent tasks list --json` aliases. */
...
/** Parse JSON-only `openagent tasks audit` filters for the route-first audit path. */
