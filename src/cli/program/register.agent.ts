...
${formatHelpExamples([
  [
    'openagent agents set-identity --agent main --name "OpenAgent" --emoji "🤖"',
    "Set name + emoji.",
  ],
  ["openagent agents set-identity --agent main --avatar avatars/openclaw.png", "Set avatar path."],
  [
    "openagent agents set-identity --workspace ~/.openclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "openagent agents set-identity --identity-file ~/.openclaw/workspace/IDENTITY.md --agent main",
