...
const subCliCommandDescriptors = [
  ...
  },
  {
    name: "devices",
    description:
      "Device pairing and auth tokens (for mobile app setup codes, use `openagent qr` instead)",
    hasSubcommands: true,
  ...
  {
    name: "connect",
    description: "Connect this machine to an OpenAgent Gateway as a node",
  ...
  {
    name: "proxy",
    description: "Run the OpenAgent debug proxy and inspect captured traffic",
    hasSubcommands: true,
  ...
  {
    name: "update",
    description: "Update OpenAgent and inspect update channel status",
    hasSubcommands: true,
  },
  {
    name: "completion",
