// Shared Zero to Agent banner: the dot-matrix lobster mascot beside the OPENCLAW
...
/**
 * Prints the Zero to Agent banner: animated on rich interactive terminals, static
