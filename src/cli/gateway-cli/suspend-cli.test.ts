...
describe("gateway suspend CLI", () => {
  ...
  it.each([undefined, 0, "0", " 0 ", "0.25", "1e1"])(
    ...
    async (waitSeconds) => {
      ...
      expect(runtime.log).toHaveBeenCalledWith(
        "Resume with: openagent gateway resume suspension-1",
      );
    },
  );
  ...
  it.each([
    {
      ...
      profile: "",
      container: "",
      command: "openagent gateway resume suspension-1",
    },
    {
      ...
      profile: "",
      container: "",
      command: "openagent gateway resume suspension-1 --port 18999",
    },
    {
      ...
      profile: "work",
      container: "",
      command: "openagent --profile work gateway resume suspension-1 --port 18999",
    },
    {
      ...
      profile: "work",
      container: "demo",
      command: "openagent --container demo gateway resume suspension-1 --port 18999",
    },
    {
