...
describe("skills-cli", () => {
  ...
  describe("ClawHub command hints", () => {
    it.each([
      {
        ...
        profile: "work",
        container: "",
        prefix: "openagent --profile work",
      },
      {
        name: "managed container",
        profile: "",
        container: "demo",
        prefix: "openagent --container demo",
      },
      {
    ...
    it("keeps profile and container guidance out of machine-readable skill output", () => {
      ...
      for (const output of outputs) {
        ...
        expect(output).not.toContain("openagent --profile");
        expect(output).not.toContain("openagent --container");
      }
    });
  });
  ...
  describe("formatSkillsList", () => {
    it("formats empty skills list", () => {
      ...
      expect(output).toContain("openagent skills search");
    });
  ...
  describe("formatSkillInfo", () => {
    it("returns not found message for unknown skill", () => {
      ...
      expect(output).toContain("openagent skills install");
    });
  ...
  describe("formatSkillsCheck", () => {
    it("shows summary of skill status", () => {
      ...
      expect(output).toContain("openagent skills update");
    });
