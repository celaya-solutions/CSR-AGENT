...
describe("renderGatewayServiceStartHints", () => {
  ...
  it("replaces only installation advice in Nix mode", () => {
    ...
    expect(hints).toContain("openagent --profile work gateway start");
  });
  ...
  it.each([
    {
      ...
      profile: "default",
      installCommand: "openagent gateway install",
      startCommand: "openagent gateway start",
    },
    {
      name: "a named profile",
      profile: "work",
      installCommand: "openagent --profile work gateway install",
      startCommand: "openagent --profile work gateway start",
    },
  ])(
