...
describe("printDaemonStatus", () => {
  ...
  it.each([
    ...
    expectMockLineContains(
      ...
      testCase.warning
        ...
        : "Other Zero to Agent launchd jobs (macOS)",
    );
  ...
  it("prints stale updater launchd job guidance", () => {
    ...
    expectMockLineContains(runtime.error, "Stale Zero to Agent updater launchd job(s) detected.");
  ...
  it("prints CLI and gateway versions with readable guidance when they differ", () => {
    ...
    expectMockLineContains(runtime.error, "this Zero to Agent command is version 2026.4.23");
    expectMockLineContains(
      runtime.error,
