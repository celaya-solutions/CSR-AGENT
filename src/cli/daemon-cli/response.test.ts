...
describe("daemon action JSON hints", () => {
  ...
  it("classifies common daemon hint kinds", () => {
    const hints = [
      ...
      "If you're in a container, run the gateway in the foreground instead of `openagent gateway`.",
    ...
    expect(writeJson).toHaveBeenCalledWith(
      expect.objectContaining({
        ...
        hints,
        hintItems: [
          { kind: "install", text: "openagent gateway install" },
          {
          ...
          },
          {
            ...
            text: "If you're in a container, run the gateway in the foreground instead of `openagent gateway`.",
          },
          {
            kind: "wsl-systemd",
  ...
  it.each([
    "openagent --profile work gateway install",
    "openagent --container demo gateway install",
    "openagent node install",
    "openagent --profile work node install",
    "openagent --container demo node install",
