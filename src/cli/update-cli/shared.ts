...
/** Locate the installed OpenAgent package root that should receive update operations. */
...
/** Ensure the configured source-update directory exists and points at an OpenAgent checkout. */
...
/** Detect the package manager that owns a global/package OpenAgent install. */
