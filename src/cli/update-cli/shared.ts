...
/** Locate the installed Zero to Agent package root that should receive update operations. */
...
/** Ensure the configured source-update directory exists and points at a Zero to Agent checkout. */
...
/** Detect the package manager that owns a global/package Zero to Agent install. */
