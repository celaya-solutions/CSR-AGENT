...
describe("completion-cli command aliases", () => {
  itWithFish.each([
    ["a canonical root command", "openagent --profile work inf", "infer"],
    ["an aliased root command", "openagent --profile work cap", "capability"],
    ["an inline profile and alias", "openagent --profile=work cap", "capability"],
    ["an alias-shaped profile value", "openagent --profile capability cap", "capability"],
    [
      "a repeated profile and alias",
      "openagent --profile first --profile second cap",
      "capability",
    ],
  ...
  itWithFish.each([
    ["an aliased nested command", "openagent cron create -"],
    ["a canonical nested command", "openagent cron add -"],
    ["a global profile", "openagent --profile work cron create -"],
    ["an inline global profile", "openagent --profile=work cron create -"],
    ["repeated global profiles", "openagent --profile first --profile second cron create -"],
    ["an inherited global profile", "openagent cron --profile work create -"],
    ["a parent long option", "openagent cron --timezone UTC create -"],
    ["a parent short option", "openagent cron -z UTC create -"],
    ["an inline parent option", "openagent cron --timezone=UTC create -"],
    ["a parent boolean option", "openagent cron --verbose create -"],
  ...
  itWithFish.each([
    ["an aliased positional argument", "openagent cron create meeting -"],
    ["a canonical positional argument", "openagent cron add meeting -"],
    ["a profiled positional argument", "openagent --profile work cron create meeting -"],
    ["a parent option and positional argument", "openagent cron -z UTC create meeting -"],
  ...
  itWithPowerShell.each([
    ["a global option", "openagent --profile work cron create --a"],
    ["an inline global option", "openagent --profile=work cron create --a"],
    ["repeated global options", "openagent --profile first --profile second cron create --a"],
    ["an inherited option after the parent", "openagent cron --profile work create --a"],
    ["the canonical nested command", "openagent --profile work cron add --a"],
