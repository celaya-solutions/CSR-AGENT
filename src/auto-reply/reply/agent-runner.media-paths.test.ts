...
describe("runReplyAgent media path normalization", () => {
  ...
  it("passes current inbound media paths as native Zero to Agent images", async () => {
  ...
  it("does not pass recent history images as unlabeled native Zero to Agent images", async () => {
