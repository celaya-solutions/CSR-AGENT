...
const MISSING_WEB_SEARCH_PROVIDER_DIAGNOSTIC_MESSAGE =
  "web_search tool requested in toolsAllow but no web search provider is selected. Configure one with: openagent configure --section web, or set tools.web.search.provider.";
    ...
    async () => {
      ...
      expect(result).toMatchObject({
        ...
        error: expect.stringContaining(
          "openagent automations edit tools-allow --tools exec,process",
        ),
        diagnostics: {
