...
These internal hooks ship with OpenAgent. They subscribe to colon-separated events
...
troubleshooting, use the canonical [Hooks guide](../../../docs/automation/hooks.md).
For command flags and Gateway targeting, see the
[hooks CLI reference](../../../docs/cli/hooks.md).
...
[authoring guide](../../../docs/automation/hooks.md#writing-hooks) for a
...
[typed plugin hooks and services](../../../docs/plugins/hooks.md) for
