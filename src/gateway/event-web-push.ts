...
function resolveEventWebPushNotification(
  ...
  if (event === "question.requested") {
    ...
    return {
      ...
      title: "Zero to Agent needs an answer",
  ...
  if (
    ...
    return {
      ...
      title: "Zero to Agent agent finished",
  ...
  if (event === "task" && value.action === "upserted") {
    ...
    return {
      ...
      title: "Zero to Agent background task failed",
  ...
  if (event === "cron" && value.action === "finished" && value.status === "error") {
    ...
    return {
      ...
      title: "Zero to Agent scheduled task failed",
