...
function resolveEventWebPushNotification(
  ...
  if (event === "question.requested") {
    ...
    return {
      ...
      title: "OpenAgent needs an answer",
  ...
  if (
    ...
    return {
      ...
      title: "OpenAgent agent finished",
  ...
  if (event === "task" && value.action === "upserted") {
    ...
    return {
      ...
      title: "OpenAgent background task failed",
  ...
  if (event === "cron" && value.action === "finished" && value.status === "error") {
    ...
    return {
      ...
      title: "OpenAgent scheduled task failed",
