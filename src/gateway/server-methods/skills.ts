      ...
      if (requested.requestedReference) {
        ...
        respond(
          ...
          errorShape(
            ...
            `ClawHub cannot return details for ${requested.requestedReference}; external skill sources are install-only. Install it directly, or run "openagent skills install ${requested.requestedReference}".`,
          ),
        );
        return;
      }
