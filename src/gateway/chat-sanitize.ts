...
// Removes OpenAgent-only envelopes before messages are shown in UI/RPC results.
...
/** Strips OpenAgent envelope metadata from one display message without mutating it. */
