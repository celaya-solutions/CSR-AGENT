...
// Removes Zero to Agent-only envelopes before messages are shown in UI/RPC results.
...
/** Strips Zero to Agent envelope metadata from one display message without mutating it. */
