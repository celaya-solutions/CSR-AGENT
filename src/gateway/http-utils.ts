...
/** Default OpenAI-compatible model alias that targets the default Zero to Agent agent. */
...
/** Checks Zero to Agent routing-model syntax without resolving fleet ownership. */
