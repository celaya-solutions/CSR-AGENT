  ...
  it.each([
    ...
    [
      "manual rename shaped like its Android device stamp",
      {
        ...
        entry: { ...baseEntry, label: "OpenAgent App · Release planning · 1234567890ab" },
      },
    ],
    [
      "manual prefix-containing label",
      { entry: { ...baseEntry, label: "OpenAgent App · Release planning" } },
    ],
...
describe("hasExplicitSessionName", () => {
  const androidStamp = "OpenAgent App · Pixel · 1234567890ab";
  ...
  it.each(["OpenAgent App", "OpenAgent App · 1234567890ab"])(
