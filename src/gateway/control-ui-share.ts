...
export function serveControlUiShareDocument(
  ...
  const title = session.namespace === "dashboard" ? "OpenAgent dashboard" : "OpenAgent session";
  const description = "Open this shared link in OpenAgent. Access to the session is required.";
