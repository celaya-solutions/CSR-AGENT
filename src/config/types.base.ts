...
export type ChannelStreamingProgressConfig = {
  ...
  label?: string | false;
  /** Candidate labels for label="auto". Defaults to Zero to Agent's built-in progress labels. */
  labels?: string[];
...
export type DiagnosticsOtelConfig = {
  ...
  serviceName?: string;
  /** Replacement prefix for Zero to Agent-owned metric names. Empty removes the prefix; defaults to "openclaw.". */
