...
const SHARED_CHANNEL_FIELD_HELP: Record<string, string> = {
  ...
  capabilities: "Override the channel capabilities Zero to Agent assumes this account supports.",
  ...
  textChunkLimit: "Maximum characters per outbound message before Zero to Agent splits it.",
