...
// Static Celaya Solutions mark; keep shapes in sync with ui/public/favicon.svg.
const LOGO_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240" aria-hidden="true"><rect width="240" height="240" rx="40" fill="#000000"/><g fill="none" stroke="#FFFFFF" stroke-width="4.5"><path d="M29 84V120M55 84V120M81 84V120M107 84V120M133 84V120M185 84V120M211 84V120"/><path d="M44 132V168M67 132V168M90 132V168M113 132V168M136 132V168M182 132V168M205 132V168"/></g><path d="M159 76V176" fill="none" stroke="#FF6B35" stroke-width="8"/><path d="M151 60H167L159 73Z" fill="#FF6B35"/></svg>`;
