...
/** Normalized object shape that Zero to Agent loads from a plugin entry module. */
 ...
 *
 * @experimental Pin and test Zero to Agent host versions; existing compatibility windows still apply.
 */
