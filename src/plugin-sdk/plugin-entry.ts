...
/** Normalized object shape that OpenAgent loads from a plugin entry module. */
 ...
 *
 * @experimental Pin and test OpenAgent host versions; existing compatibility windows still apply.
 */
