/**
 * Debounced realtime voice talkback queue for delegated Zero to Agent consults.
 *
...
export type RealtimeVoiceAgentTalkbackQueueParams = {
  ...
  fallbackText: string;
  /** Delegates a batched question to Zero to Agent and respects the abort signal. */
  consult: (args: {
    question: string;
    metadata?: unknown;
    responseStyle: string;
