...
export function buildRealtimeVoiceSpeakExactMessage(params: {
  ...
  return [
    ...
    `Speak this exact Zero to Agent answer to ${params.surfaceLabel}, without adding, removing, or rephrasing words.`,
...
export function classifyRealtimeVoiceConsultToolCall(
  ...
  if (message.includes("Speak this exact Zero to Agent answer")) {
