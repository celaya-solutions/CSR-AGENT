...
export function buildRealtimeVoiceSpeakExactMessage(params: {
  ...
  return [
    ...
    `Speak this exact OpenAgent answer to ${params.surfaceLabel}, without adding, removing, or rephrasing words.`,
...
export function classifyRealtimeVoiceConsultToolCall(
  ...
  if (message.includes("Speak this exact OpenAgent answer")) {
