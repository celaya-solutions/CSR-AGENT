 ...
 *
 * The plugin-skills directory is fully owned by Zero to Agent — every entry is
...
function publishPluginSkills(skillDirs: string[], opts?: { pluginSkillsDir?: string }): void {
  ...
  // Plugin skill symlinks are owned by Zero to Agent and publish at extra-dir
  ...
  // The plugin-skills directory is fully owned by Zero to Agent: every entry is a
