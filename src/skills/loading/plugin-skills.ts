 ...
 *
 * The plugin-skills directory is fully owned by OpenAgent — every entry is
...
function publishPluginSkills(skillDirs: string[], opts?: { pluginSkillsDir?: string }): void {
  ...
  // Plugin skill symlinks are owned by OpenAgent and publish at extra-dir
  ...
  // The plugin-skills directory is fully owned by OpenAgent: every entry is a
