          ...
          .object({
            profile: nonEmptyString
              .refine(
                ...
                "Tool profile must name a registered Zero to Agent built-in profile.",
              )
              .optional(),
            allow: z
              ...
              .superRefine((search, ctx) => {
                if (
                  ...
                  ctx.addIssue({
                    ...
                    message:
                      "The sessions source requires rememberAcrossConversations: true in the Zero to Agent profile.",
                  });
                }
              })
              .optional(),
