// Creates temporary OpenAgent directories for runtime scratch work.
import { getSealedRuntimeSecureTempRoot } from "./sealed-runtime-registry.js";

/** Preferred shared OpenAgent temp root on POSIX systems when ownership and permissions are safe. */
...
/** Resolves a safe OpenAgent temp root, falling back to user-scoped os.tmpdir paths when needed. */
export function resolvePreferredOpenClawTmpDir(
  ...
  return loadResolveSecureTempRoot()({
    ...
    unsafeFallbackLabel: "OpenAgent temp dir",
