// Creates temporary Zero to Agent directories for runtime scratch work.
import { getSealedRuntimeSecureTempRoot } from "./sealed-runtime-registry.js";

/** Preferred shared Zero to Agent temp root on POSIX systems when ownership and permissions are safe. */
...
/** Resolves a safe Zero to Agent temp root, falling back to user-scoped os.tmpdir paths when needed. */
export function resolvePreferredOpenClawTmpDir(
  ...
  return loadResolveSecureTempRoot()({
    ...
    unsafeFallbackLabel: "Zero to Agent temp dir",
