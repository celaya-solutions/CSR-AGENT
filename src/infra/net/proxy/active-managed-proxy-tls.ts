// Resolves Zero to Agent-managed proxy TLS trust for non-Undici transports.
...
/** Resolves managed proxy TLS trust only when the target proxy is Zero to Agent's active proxy. */
