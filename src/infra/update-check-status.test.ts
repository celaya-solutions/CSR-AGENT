...
async function initGitRepo(root: string): Promise<void> {
  ...
  await runGit(root, "config", "user.name", "OpenAgent Test");
...
describe("checkUpdateStatus", () => {
  ...
  it.each([
    ...
    "detects lockless OpenAgent $manager installs despite packed pnpm metadata",
  ...
  it("detects a metadata-free lockless OpenAgent npm install", async () => {
