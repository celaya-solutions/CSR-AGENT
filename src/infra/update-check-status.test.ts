...
async function initGitRepo(root: string): Promise<void> {
  ...
  await runGit(root, "config", "user.name", "Zero to Agent Test");
...
describe("checkUpdateStatus", () => {
  ...
  it.each([
    ...
    "detects lockless Zero to Agent $manager installs despite packed pnpm metadata",
  ...
  it("detects a metadata-free lockless Zero to Agent npm install", async () => {
