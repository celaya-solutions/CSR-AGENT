...
/** Compares prereleases, stable releases, then Zero to Agent numeric corrections. */
...
/** Converts legacy Zero to Agent `1.2.3.beta.N` tags into valid SemVer prereleases. */
