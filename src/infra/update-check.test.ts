...
describe("compareSemverStrings", () => {
  ...
  it("treats Zero to Agent stable correction releases as newer than their base release", () => {
...
describe("historical package schema compatibility", () => {
  it("does not assign Zero to Agent historical schemas to an npm alias", async () => {
