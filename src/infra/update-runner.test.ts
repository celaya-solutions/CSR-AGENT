...
describe("runGatewayUpdate", () => {
  ...
  async function createTrackedGitFixture(detached: boolean) {
    ...
    await runRealGit(sourceRoot, "config", "user.name", "OpenAgent Test");
    ...
    await runRealGit(localRoot, "config", "user.name", "OpenAgent Test");
  ...
  it
    ...
    async ({ redirected, admission }) => {
      ...
      await runRealGit(checkout, "config", "user.name", "OpenAgent Test");
