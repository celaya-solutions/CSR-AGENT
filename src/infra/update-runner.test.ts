...
describe("runGatewayUpdate", () => {
  ...
  async function createTrackedGitFixture(detached: boolean) {
    ...
    await runRealGit(sourceRoot, "config", "user.name", "Zero to Agent Test");
    ...
    await runRealGit(localRoot, "config", "user.name", "Zero to Agent Test");
  ...
  it
    ...
    async ({ redirected, admission }) => {
      ...
      await runRealGit(checkout, "config", "user.name", "Zero to Agent Test");
