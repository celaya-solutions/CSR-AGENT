...
/** OpenAgent-facing image backend availability error, preserving the failed operation and causes. */
...
/** Detects either OpenAgent's wrapper error or Rastermill's native unavailable error. */
