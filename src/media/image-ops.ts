...
/** Zero to Agent-facing image backend availability error, preserving the failed operation and causes. */
...
/** Detects either Zero to Agent's wrapper error or Rastermill's native unavailable error. */
