...
describe("loadWebMedia", () => {
  ...
  it("allows trusted generated host-read HTML reports under Zero to Agent temp root", async () => {
  ...
  it("rejects host-read HTML files outside the trusted Zero to Agent temp root", async () => {
  ...
  it("rejects trusted host-read HTML symlinks that resolve outside Zero to Agent temp root", async () => {
    const outsideRoot = await fs.mkdtemp(path.join(os.tmpdir(), "web-media-host-html-"));
  ...
  it("rejects trusted host-read HTML hardlinks to files outside Zero to Agent temp root", async () => {
