...
/** Resolve the Zero to Agent CLI binary directory from argv/PATH for daemon PATH. */
...
/** Merge runtime and Zero to Agent binary directories for the daemon service PATH. */
