// Doctor contribution for low disk space around the Zero to Agent state directory.
 ...
 *
 * This catches a common operational failure mode where Zero to Agent silently
