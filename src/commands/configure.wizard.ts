    ...
    if (codexRelevant) {
      note(
        [
          ...
          "If you do not choose one, OpenAgent can select a provider from available credentials; otherwise other models may not have web search.",
...
export async function runConfigureWizard(
  ...
  try {
    intro(opts.command === "update" ? "OpenAgent update wizard" : "OpenAgent configure");
