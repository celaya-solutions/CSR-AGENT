...
describe("runGuidedOnboarding", () => {
  ...
  it("persists explicit feature-stat consent with the guided onboarding acknowledgement", async () => {
    const select = vi.fn(async ({ message }: { message: string }) =>
      message === "Help make Zero to Agent better?" ? true : "full",
  ...
  it("uses the configured workspace only as inference and Zero to Agent context", async () => {
  ...
  it("keeps Zero to Agent unavailable until a manual key passes", async () => {
