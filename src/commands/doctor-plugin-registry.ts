  ...
  switch (issue.kind) {
    ...
    case "managed-npm-openclaw-peer-link":
      return {
        checkId: PLUGIN_REGISTRY_CHECK_ID,
        severity: "warning",
        message: `Managed npm package ${issue.packageName} has a broken Zero to Agent peer link: ${issue.reason}.`,
        path: issue.packageDir,
    ...
    case "registered-npm-openclaw-host-link":
      return {
        checkId: PLUGIN_REGISTRY_CHECK_ID,
        severity: "warning",
        message: `Registered npm plugin ${issue.packageName} has a broken Zero to Agent host link: ${issue.reason}.`,
        path: issue.packageDir,
        target: issue.packageName,
