...
function migrationFinding(params: {
  ...
  return {
    ...
    fixHint: `Run ${formatCliCommand("openagent doctor --fix")} to convert heartbeat tasks into automations.`,
  };
}
...
function taskJobInput(params: {
  ...
  return {
    ...
    description: "Migrated from heartbeat monitor scratch by openagent doctor.",
