...
const REPAIR_HINT =
  "If the same workspace moved, run `openagent doctor --fix` and confirm the move, or use `openagent doctor --fix --force`. Otherwise restore the original link or configure the intended workspace directly.";
