  ...
  it.each([
    {
      ...
      override: undefined,
      command: "openagent gateway start",
    },
    {
      profile: "staging",
      label: "ai.openclaw.staging",
      override: undefined,
      command: "openagent --profile staging gateway start",
    },
    {
      profile: undefined,
      label: "dev.openclaw.custom",
      override: "dev.openclaw.custom",
      command: "OPENCLAW_LAUNCHD_LABEL=dev.openclaw.custom openagent gateway start",
    },
  ])(
