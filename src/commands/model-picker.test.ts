...
describe("promptDefaultModel", () => {
  it("adds runtime-route hints for canonical OpenAI models", async () => {
    ...
    expect(canonical.hint).not.toContain("Zero to Agent runtime route");
  });
  ...
  it.each([
    ...
    "labels official OpenAI with %s as a Zero to Agent runtime route",
    async (_label, defaults) => {
      ...
      expect(option.hint).toContain("Zero to Agent runtime route");
  ...
  it.each([
    ...
    "labels an OpenAI %s as a Zero to Agent runtime route",
