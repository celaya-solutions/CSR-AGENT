    ...
    return [
      {
        ...
        fixHint: "Restore access to the project registry and rerun openagent doctor.",
      },
    ];
  }
      ...
      findings.push({
        ...
        fixHint: [
          ...
          ...keys
            ...
            .flatMap(unset),
          "git repack -a -d",
          "Rerun openagent doctor. If history or objects remain missing, recover them from the original repository.",
        ].join("\n"),
      });
    } catch {
      findings.push({
        ...
        fixHint:
          "Check the clone path, permissions, and Git installation, then rerun openagent doctor.",
      });
    }
  }
  return findings;
