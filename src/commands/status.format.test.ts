...
describe("status config diagnostic formatting", () => {
  it.each([
    ["default", undefined, undefined, "openagent doctor --fix"],
    ["profile", "work", undefined, "openagent --profile work doctor --fix"],
    ["container", undefined, "staging", "openagent --container staging doctor --fix"],
    ["container over profile", "work", "staging", "openagent --container staging doctor --fix"],
