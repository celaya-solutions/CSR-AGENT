...
const SYSTEM_PROMPT_OVERRIDE_LEGACY_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'agents.defaults.systemPromptOverride was removed; OpenAgent owns the generated system prompt. Run "openclaw doctor --fix" to remove it.',
  },
  {
    path: ["agents"],
    message:
      'agents.entries.*.systemPromptOverride was removed; OpenAgent owns the generated system prompt. Run "openclaw doctor --fix" to remove it.',
    match: (value) =>
