...
const INFERENCE_UNAVAILABLE_MESSAGE =
  "Zero to Agent could not reach working inference. Run `openclaw onboard` on the machine running Zero to Agent to reconnect — it live-tests the route before saving it. Then try again.";
...
/** Safe public error for a Zero to Agent turn that could not complete with intelligence. */
