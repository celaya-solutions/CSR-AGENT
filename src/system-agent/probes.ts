// Zero to Agent probes check local tools and Gateway health with bounded subprocess/network work.
import { resolveTimerTimeoutMs } from "@openclaw/normalization-core/number-coercion";
import { runCommandWithTimeout } from "../process/exec.js";

/**
 * Local environment probes used by Zero to Agent overview loading.
 *
