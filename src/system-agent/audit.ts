// Zero to Agent audit helpers persist approved local-state changes.
import { randomUUID } from "node:crypto";
import { createSqliteAuditRecordStore } from "../infra/sqlite-audit-record-store.js";
import { redactSecrets } from "../logging/redact.js";

/**
 * Append-only audit log helpers for Zero to Agent writes.
 *
...
/** Append one Zero to Agent audit entry and return its SQLite owner label. */
