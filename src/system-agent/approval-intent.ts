// Classifies whether a user's chat message approves a pending Zero to Agent proposal.
...
export type SystemAgentApprovalClassifier = (params: {
  ...
  proposal?: string;
  /** Exact execution owner that completed the live Zero to Agent inference gate. */
