 ...
 * `openagent migrate` already answers an unknown provider this way; onboarding has to match, because
...
function assertListedMigrationProvider(
  ...
  const listCommand = formatCliCommand("openagent migrate list");
  throw new Error(
