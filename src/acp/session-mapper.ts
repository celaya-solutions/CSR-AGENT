/** Resolves ACP request metadata into Zero to Agent Gateway session keys and reset behavior. */
...
/** Parses ACP request metadata into Zero to Agent session routing hints. */
