...
const SERVICE_DEFINITION_REASONS = {
  ...
  symlink:
    "is a symbolic link. Ask the deployment owner to replace the managed file through the deployment process; Zero to Agent will not rewrite the link or its target.",
  "foreign-owner":
