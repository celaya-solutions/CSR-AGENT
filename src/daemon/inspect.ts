/** Inspects installed platform services for extra OpenAgent or legacy gateway jobs. */
...
function isOpenClawGatewayTaskName(name: string): boolean {
  ...
  // \OpenAgent Gateway for root-folder tasks). Strip the leading
  ...
  return stripped === defaultName || /^openagent gateway \(.+\)$/.test(stripped);
}
