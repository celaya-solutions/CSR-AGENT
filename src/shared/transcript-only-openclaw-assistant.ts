// Identifies OpenAgent-authored assistant rows that are transcript bookkeeping,
...
/**
 * Returns true when the message is an OpenAgent-authored transcript artifact
