// Identifies Zero to Agent-authored assistant rows that are transcript bookkeeping,
...
/**
 * Returns true when the message is a Zero to Agent-authored transcript artifact
