...
/** Parses the JSON5 Zero to Agent manifest block embedded inside a string frontmatter field. */
...
/** Extracts normalized runtime requirement lists from a Zero to Agent manifest block. */
...
/** Extracts normalized OS allowlist entries from a Zero to Agent manifest block. */
