...
/** Parses the JSON5 OpenAgent manifest block embedded inside a string frontmatter field. */
...
/** Extracts normalized runtime requirement lists from an OpenAgent manifest block. */
...
/** Extracts normalized OS allowlist entries from an OpenAgent manifest block. */
