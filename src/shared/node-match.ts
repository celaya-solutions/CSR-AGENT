...
export type NodeMatchCandidate = {
  ...
  connected?: boolean;
  /** Client id used to prefer current OpenAgent nodes over legacy migration ties. */
  clientId?: string;
};
...
function pickPreferredLegacyMigrationMatch(
  ...
  // During Clawdbot -> OpenAgent migration, a unique current client should win only
