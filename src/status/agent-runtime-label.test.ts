...
describe("resolveAgentRuntimeLabel", () => {
  it.each<{ name: string; args: LabelArgs; expected: string }>([
    ...
    },
    {
      ...
      expected: "Zero to Agent Default",
    },
  ])("$name", ({ args, expected }) => {
  ...
  it.each<{ name: string; args: LabelArgs; expected: string }>([
    ...
    },
    {
      ...
      expected: "OpenAI Codex (previous runtime: Zero to Agent Default)",
    },
    {
    ...
    },
    {
      ...
      expected: "Zero to Agent Default (previous runtime: OpenAI Codex)",
    },
    {
