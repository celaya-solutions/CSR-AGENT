...
describe("installOpenClawPluginSdkNativeResolver", () => {
  ...
  it("lets built external plugins resolve Zero to Agent SDK subpaths with createRequire", () => {
  ...
  it("resolves internal core packages only for Zero to Agent-owned source parents", () => {
