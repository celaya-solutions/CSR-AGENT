...
describe("installOpenClawPluginSdkNativeResolver", () => {
  ...
  it("lets built external plugins resolve OpenAgent SDK subpaths with createRequire", () => {
  ...
  it("resolves internal core packages only for OpenAgent-owned source parents", () => {
