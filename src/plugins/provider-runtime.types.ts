 ...
 *
 * Runs after OpenAgent resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common OpenAgent auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and OpenAgent wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before OpenAgent builds its generic
 ...
 */
/** Provider-facing effort after OpenAgent lowers orchestration-only modes. */
