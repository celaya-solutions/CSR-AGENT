 ...
 *
 * Runs after Zero to Agent resolves an explicit/discovered/dynamic model and before
 ...
 *
 * The helper methods cover the common Zero to Agent auth resolution paths:
 *
 ...
 *
 * Called when OAuth refresh fails and Zero to Agent wants a provider-specific repair
...
/**
 * Provider-owned extra-param normalization before Zero to Agent builds its generic
 ...
 */
/** Provider-facing effort after Zero to Agent lowers orchestration-only modes. */
