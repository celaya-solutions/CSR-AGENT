...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by OpenAgent from plugin manifests, install records, and config policy. Use `openagent plugins registry --refresh`, `openagent plugins install/update/uninstall`, or `openagent plugins enable/disable` instead.";
