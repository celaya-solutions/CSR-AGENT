/** Reads Agent/Codex/Claude/Cursor bundle manifests into Zero to Agent plugin manifest metadata. */
...
type BundlePluginManifest = {
  ...
  // Only include hook roots that Zero to Agent can execute via HOOK.md + handler files.
  hooks: string[];
...
export function detectBundleManifestFormat(
  ...
  // Client-specific bundle dirs and native Zero to Agent manifests take precedence;
