/** Reads Agent/Codex/Claude/Cursor bundle manifests into OpenAgent plugin manifest metadata. */
...
type BundlePluginManifest = {
  ...
  // Only include hook roots that OpenAgent can execute via HOOK.md + handler files.
  hooks: string[];
...
export function detectBundleManifestFormat(
  ...
  // Client-specific bundle dirs and native OpenAgent manifests take precedence;
