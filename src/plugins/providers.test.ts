...
function expectLastSetupRegistryCall(params: {
  ...
  const call = getLastMockCallArg(loadOpenClawPluginsMock, "OpenAgent plugin setup loader");
...
function getLastSetupLoadedPluginConfig() {
  const call = expectRecordFields(
    getLastMockCallArg(loadOpenClawPluginsMock, "OpenAgent plugin setup loader"),
    {},
  );
