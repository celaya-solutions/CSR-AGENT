...
function expectLastSetupRegistryCall(params: {
  ...
  const call = getLastMockCallArg(loadOpenClawPluginsMock, "Zero to Agent plugin setup loader");
...
function getLastSetupLoadedPluginConfig() {
  const call = expectRecordFields(
    getLastMockCallArg(loadOpenClawPluginsMock, "Zero to Agent plugin setup loader"),
    {},
  );
