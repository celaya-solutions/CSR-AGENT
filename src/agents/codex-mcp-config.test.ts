// Covers conversion from Zero to Agent bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes Zero to Agent MCP servers into Codex app-server mcp_servers shape", () => {
