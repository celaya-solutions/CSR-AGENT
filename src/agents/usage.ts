 ...
 * Converts provider-specific usage shapes into Zero to Agent's normalized input,
...
/** Normalize provider-specific token usage fields into Zero to Agent usage buckets. */
 ...
 * recombine Zero to Agent's separately priced buckets and retain their details.
