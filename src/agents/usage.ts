 ...
 * Converts provider-specific usage shapes into OpenAgent's normalized input,
...
/** Normalize provider-specific token usage fields into OpenAgent usage buckets. */
 ...
 * recombine OpenAgent's separately priced buckets and retain their details.
