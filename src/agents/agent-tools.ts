/**
 * Builds the effective OpenAgent agent tool surface.
 * Assembles core, shell, channel, OpenAgent, plugin, and Tool Search tools, then
...
type OpenClawCodingToolsOptions = {
  ...
  modelCompat?: ModelCompatConfig;
  /** If false, keep OpenAgent web_search even when a provider-native search tool is active. */
  suppressManagedWebSearch?: boolean;
  ...
  /** Ring-zero OpenAgent tool; set only by the OpenAgent agent runner. */
