...
describe("gateway tool defaults", () => {
  ...
  it("explains stale gateway cron connection metadata rejections", async () => {
    ...
    await expect(
      ...
      "The running Gateway is from an older OpenAgent build and rejected current agent runtime connection metadata. Restart the Gateway with `openagent gateway restart`, then retry.",
    );
