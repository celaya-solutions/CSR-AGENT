...
describe("detectImageReferences", () => {
  ...
  it("ignores OpenAgent CLI image cache paths from prior prompt transcripts", () => {
  ...
  it("ignores temporary OpenAgent CLI image cache paths", () => {
  ...
  it("ignores file URLs into the OpenAgent CLI image cache", () => {
