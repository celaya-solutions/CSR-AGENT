...
describe("detectImageReferences", () => {
  ...
  it("ignores Zero to Agent CLI image cache paths from prior prompt transcripts", () => {
  ...
  it("ignores temporary Zero to Agent CLI image cache paths", () => {
  ...
  it("ignores file URLs into the Zero to Agent CLI image cache", () => {
