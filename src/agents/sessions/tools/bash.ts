...
/**
 * Create bash operations using Zero to Agent runtime's built-in local shell execution backend.
 *
 * This is useful for extensions that intercept user_bash and still want Zero to Agent runtime's
