 ...
 *
 * Wraps pi-tui keybindings with Zero to Agent-specific actions and per-agent overrides.
 */
...
/** Zero to Agent-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads Zero to Agent defaults plus optional user overrides. */
