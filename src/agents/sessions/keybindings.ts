 ...
 *
 * Wraps pi-tui keybindings with OpenAgent-specific actions and per-agent overrides.
 */
...
/** OpenAgent-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Keybinding manager that loads OpenAgent defaults plus optional user overrides. */
