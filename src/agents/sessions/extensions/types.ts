...
export interface ExtensionContext {
  ...
  /** Gracefully shut down OpenAgent and exit. Available in all contexts. */
  shutdown(): void;
...
interface ProviderModelConfig {
  ...
  reasoning: boolean;
  /** Maps OpenAgent thinking levels to provider/model-specific values; null marks a level unsupported. */
