...
export interface ExtensionContext {
  ...
  /** Gracefully shut down Zero to Agent and exit. Available in all contexts. */
  shutdown(): void;
...
interface ProviderModelConfig {
  ...
  reasoning: boolean;
  /** Maps Zero to Agent thinking levels to provider/model-specific values; null marks a level unsupported. */
