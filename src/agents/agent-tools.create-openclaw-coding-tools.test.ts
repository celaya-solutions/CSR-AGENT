...
describe("createOpenClawCodingTools", () => {
  ...
  it("keeps Tool Search controls when core Zero to Agent tools are not materialized", () => {
  ...
  it("passes source reply delivery mode to Zero to Agent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes configured filesystem policy to Zero to Agent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes plugin suppression into Zero to Agent tool construction plans", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("forwards trusted conversation recall to Zero to Agent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("keeps plugin-only construction off the Zero to Agent core factory", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes explicit denylist entries to Zero to Agent tool factory planning", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes inherited allowlist entries to Zero to Agent plugin discovery", async () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
