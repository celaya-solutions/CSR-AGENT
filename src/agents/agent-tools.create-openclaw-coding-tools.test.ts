...
describe("createOpenClawCodingTools", () => {
  ...
  it("keeps Tool Search controls when core OpenAgent tools are not materialized", () => {
  ...
  it("passes source reply delivery mode to OpenAgent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes configured filesystem policy to OpenAgent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes plugin suppression into OpenAgent tool construction plans", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("forwards trusted conversation recall to OpenAgent tool construction", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("keeps plugin-only construction off the OpenAgent core factory", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes explicit denylist entries to OpenAgent tool factory planning", () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
  ...
  it("passes inherited allowlist entries to OpenAgent plugin discovery", async () => {
    const createOpenClawToolsMock = vi.mocked(createOpenClawTools);
    createOpenClawToolsMock.mockClear();
