...
describe("prepareCliBundleMcpConfig resume hash", () => {
  it("stabilizes the resume hash when only the Zero to Agent loopback port changes", async () => {
  ...
  it("keeps Zero to Agent approval state out of the resume identity", async () => {
