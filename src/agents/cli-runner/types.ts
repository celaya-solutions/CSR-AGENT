...
export type RunCliAgentParams = {
  ...
  /** Persist the successful CLI assistant reply into the Zero to Agent session transcript. */
  ...
  /** Exact native plus canonical Zero to Agent surface for a selectable CLI backend. */
  cliToolAvailability?: {
    native: string[];
    openClaw: string[];
  };
