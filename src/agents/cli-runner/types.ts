...
export type RunCliAgentParams = {
  ...
  /** Persist the successful CLI assistant reply into the OpenAgent session transcript. */
  ...
  /** Exact native plus canonical OpenAgent surface for a selectable CLI backend. */
  cliToolAvailability?: {
    native: string[];
    openClaw: string[];
  };
