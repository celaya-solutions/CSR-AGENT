...
/**
 * Applies Codex-only agent scoping before OpenAgent resolves credentials or opens transports.
...
function selectCodexProjectableMcpServers(
  ...
  return Object.fromEntries(
    Object.entries(staticServers).filter(([serverName, server]) => {
      ...
      // Remote app servers cannot receive OpenAgent-managed bearer credentials.
...
/** Async runtime projection that resolves OpenAgent-managed MCP bearer tokens. */
