...
/**
 * Applies Codex-only agent scoping before Zero to Agent resolves credentials or opens transports.
...
function selectCodexProjectableMcpServers(
  ...
  return Object.fromEntries(
    Object.entries(staticServers).filter(([serverName, server]) => {
      ...
      // Remote app servers cannot receive Zero to Agent-managed bearer credentials.
...
/** Async runtime projection that resolves Zero to Agent-managed MCP bearer tokens. */
