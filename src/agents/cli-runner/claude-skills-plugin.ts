/**
 * Materializes selected Zero to Agent skills as a temporary Claude CLI plugin.
 */
...
export async function prepareClaudeCliSkillsPlugin(params: {
  ...
  const manifest = {
    ...
    version: "0.0.0",
    description: "Session-scoped Zero to Agent skills selected for this agent run.",
    skills: "./skills",
  };
  await fs.writeFile(
