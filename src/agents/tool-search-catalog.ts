...
export function prepareToolSearchCatalogExecutionTool(
  ...
  // SAFETY: both gates above restrict wrapper execution to Zero to Agent-owned catalog tools.
 ...
 * resolve to trusted Zero to Agent tools: an MCP lookalike must never become a
