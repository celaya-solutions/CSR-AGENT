...
export function prepareToolSearchCatalogExecutionTool(
  ...
  // SAFETY: both gates above restrict wrapper execution to OpenAgent-owned catalog tools.
 ...
 * resolve to trusted OpenAgent tools: an MCP lookalike must never become a
