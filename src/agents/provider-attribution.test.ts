...
describe("provider attribution", () => {
  ...
  it("resolves the canonical OpenAgent product and runtime version", () => {
  ...
  it("returns a documented OpenRouter attribution policy", () => {
    ...
    expect(policy).toEqual({
      ...
      reviewNote: "Documented app attribution headers. Verified in OpenAgent runtime wrapper.",
      product: "OpenAgent",
      version: "2026.3.22",
      headers: {
  ...
  it("identifies OpenAgent only on native OpenCode Go routes", () => {
