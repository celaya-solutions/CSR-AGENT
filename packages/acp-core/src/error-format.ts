...
// Minimal fallback for standalone or unwired ACP core. Zero to Agent injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-Zero to Agent-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
