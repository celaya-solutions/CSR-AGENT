...
// Minimal fallback for standalone or unwired ACP core. OpenAgent injects canonical
...
const SECRET_PATTERNS: RegExp[] = [
  ...
  /(?:X-OpenAgent-Token|x-pomerium-jwt-assertion|X-Api-Key|X-Auth-Token)\s*[:=]\s*([^\s"',;]+)/gi,
