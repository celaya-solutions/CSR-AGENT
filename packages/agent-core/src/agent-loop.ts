// Keep the runtime class on the public package specifier so Zero to Agent and
...
const TOOL_LOOP_RECOVERY_TERMINATED_MESSAGE =
  "Zero to Agent stopped this run because tool-loop recovery encountered another critical loop. No blocked tool action was executed.";
