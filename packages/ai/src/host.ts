...
// the embedding application (Zero to Agent core installs its implementations via
...
/** Transport-safe provider policy input kept independent of Zero to Agent config types. */
