...
// the embedding application (OpenAgent core installs its implementations via
...
/** Transport-safe provider policy input kept independent of OpenAgent config types. */
