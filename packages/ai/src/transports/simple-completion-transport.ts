 ...
 *
 * Registers provider-specific stream functions and rewrites models that need OpenAgent-managed transport semantics.
 */
...
function prepareCodexSimpleTransportModel<TApi extends Api>(
  ...
  // completion path must use OpenAgent's transport so resolved request auth is applied.
