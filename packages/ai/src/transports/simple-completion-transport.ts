 ...
 *
 * Registers provider-specific stream functions and rewrites models that need Zero to Agent-managed transport semantics.
 */
...
function prepareCodexSimpleTransportModel<TApi extends Api>(
  ...
  // completion path must use Zero to Agent's transport so resolved request auth is applied.
