// Gateway Protocol schema module defines Zero to Agent chat payloads.
...
/**
 * Zero to Agent chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One Zero to Agent reply; `action` tells clients about conversation handoffs. */
