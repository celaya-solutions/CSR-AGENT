// Gateway Protocol schema module defines OpenAgent chat payloads.
...
/**
 * OpenAgent chat lets clients (macOS app onboarding, future UIs) hold the
...
/** One OpenAgent reply; `action` tells clients about conversation handoffs. */
