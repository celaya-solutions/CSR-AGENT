...
describe("Zero to Agent chat params protocol", () => {
...
describe("Zero to Agent chat question protocol", () => {
  const question = {
...
describe("Zero to Agent chat history protocol", () => {
...
describe("Zero to Agent interactive activation protocol", () => {
...
describe("Zero to Agent setup detection protocol", () => {
  it.each([
      ...
      unavailableCandidates: [
        {
          ...
          reason: "Reconnect through Zero to Agent or use a Gemini API key.",
...
describe("Zero to Agent setup verification protocol", () => {
