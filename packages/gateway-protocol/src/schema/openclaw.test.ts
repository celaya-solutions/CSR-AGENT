...
describe("OpenAgent chat params protocol", () => {
...
describe("OpenAgent chat question protocol", () => {
  const question = {
...
describe("OpenAgent chat history protocol", () => {
...
describe("OpenAgent interactive activation protocol", () => {
...
describe("OpenAgent setup detection protocol", () => {
  it.each([
      ...
      unavailableCandidates: [
        {
          ...
          reason: "Reconnect through OpenAgent or use a Gemini API key.",
...
describe("OpenAgent setup verification protocol", () => {
