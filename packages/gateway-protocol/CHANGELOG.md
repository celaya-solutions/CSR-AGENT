...
Wire-protocol and schema contracts for the OpenAgent Gateway (WebSocket JSON-RPC-style
...
- Add OpenAgent SDK package and authenticated iOS background presence beacon (#73330).
