...
/** Provider API families with first-class request/stream adapters in OpenAgent. */
...
/** Image-generation API families with first-class adapters in OpenAgent. */
...
/** Image provider ids with first-class adapters in OpenAgent. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps OpenAgent thinking levels to provider/model-specific values.
