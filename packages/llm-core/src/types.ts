...
/** Provider API families with first-class request/stream adapters in Zero to Agent. */
...
/** Image-generation API families with first-class adapters in Zero to Agent. */
...
/** Image provider ids with first-class adapters in Zero to Agent. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps Zero to Agent thinking levels to provider/model-specific values.
