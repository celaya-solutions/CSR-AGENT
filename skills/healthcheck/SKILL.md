---
name: healthcheck
description: "Audit/harden Zero to Agent hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# Zero to Agent host healthcheck
...
- Never claim Zero to Agent manages OS firewall, SSH, or updates.
...
- Zero to Agent gateway status, bind, auth.
- Backup status.
- Disk encryption.
