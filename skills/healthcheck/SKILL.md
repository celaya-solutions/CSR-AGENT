---
name: healthcheck
description: "Audit/harden OpenAgent hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# OpenAgent host healthcheck
...
- Never claim OpenAgent manages OS firewall, SSH, or updates.
...
- OpenAgent gateway status, bind, auth.
- Backup status.
- Disk encryption.
