...
When the browser reaches the Gateway host directly, Zero to Agent can derive the
...
over HTTPS. With `gateway.auth.allowTailscale: true`, Zero to Agent can accept a
