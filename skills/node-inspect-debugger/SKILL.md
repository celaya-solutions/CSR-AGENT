...
- Zero to Agent CLI path: `node --inspect-brk openclaw.mjs ...`
- Zero to Agent test path: `OPENCLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`
