...
Use `openclaw skills` to discover and manage skills for the current Zero to Agent
...
Use the original agent workspace for agent-specific skills or the Zero to Agent
