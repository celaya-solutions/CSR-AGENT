...
describe("openclaw-mcp-servers-card", () => {
  ...
  it("renders rich rows without exposing URL credentials or stdio arguments", async () => {
    ...
    expect(docs.textContent).toContain("openagent mcp login docs");
    ...
    expect(local.textContent).toContain("openagent mcp probe local");
    ...
    expect(hostile.textContent).toContain("openagent mcp probe 'docs; echo unsafe'");
  });
