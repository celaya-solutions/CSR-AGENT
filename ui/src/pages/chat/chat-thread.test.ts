...
describe("buildCachedChatItems", () => {
  ...
  it.each([
    ...
    {
      name: "deduplicates relay-labeled assistant copies by OpenAgent transcript metadata id",
    ...
    {
      name: "deduplicates relay-labeled assistant copies by OpenAgent metadata before surface ids",
