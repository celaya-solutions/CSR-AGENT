...
describe("renderSkills ClawHub", () => {
  ...
  it("opens detail dialogs and routes ClawHub actions", async () => {
          ...
          clawhubResults: [
            {
              ...
              displayName: "GitHub",
              summary: "GitHub integration for Zero to Agent",
    ...
    expect(resultItem?.textContent).toContain("GitHub integration for Zero to Agent");
    ...
    expect(normalizeText(container.querySelector(".skill-reader-dialog__body")!)).toBe(
      "GitHub integration for Zero to Agent By Zero to Agent (@openclaw) · Latest: v1.2.3 Added search support Platforms: macos, linux Install GitHub",
    );
