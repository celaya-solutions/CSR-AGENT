...
describe("renderSkills ClawHub", () => {
  ...
  it("opens detail dialogs and routes ClawHub actions", async () => {
    ...
    expect(resultItem?.textContent).toContain("GitHub integration for OpenAgent");
    ...
    expect(normalizeText(container.querySelector(".skill-reader-dialog__body")!)).toBe(
      "GitHub integration for OpenAgent By OpenAgent (@openclaw) · Latest: v1.2.3 Added search support Platforms: macos, linux Install GitHub",
    );
