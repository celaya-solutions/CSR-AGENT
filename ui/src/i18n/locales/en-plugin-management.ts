...
const enPluginManagement = {
  pluginsPage: {
    ...
    detailBuiltWith: "Built with OpenAgent",
    ...
    installSavedNotApplied:
      "Installation of {name} was saved, but the Gateway has not applied it. {error} Fix the reported problem, then run openagent plugins reload {name}.",
    ...
    optionalCapability: "Optional OpenAgent capability.",
    enabled: "Enabled",
    disabled: "Disabled",
    available: "Available",
