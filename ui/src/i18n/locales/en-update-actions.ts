...
const enUpdateActions = {
  updates: {
    confirm: {
      ...
      macMessage:
        "Hands this update to the Zero to Agent Mac app, which installs it and restarts the Gateway it manages.",
      impact:
    ...
    report: {
      ...
      message:
        "Review the sanitized report below. Confirming will submit it with the authenticated GitHub CLI when available; otherwise Zero to Agent will offer a prefilled issue link or save the sanitized report locally.",
