...
const enLogin = {
  login: {
    heading: "Connect to Zero to Agent",
    ...
    setupCodeHint:
      "This is a device setup code for the Zero to Agent mobile app, not the Gateway secret. Paste it in the app's Gateway settings instead; the Gateway secret comes from openclaw gateway auth-token --show on the Gateway host.",
    ...
    failure: {
      ...
      protocol: {
        ...
        stepRestart:
          "Restart the Gateway after updating Zero to Agent so it serves the current protocol.",
      },
      network: {
