...
const enLogin = {
  login: {
    ...
    setupCodeHint:
      "This is a device setup code for the OpenAgent mobile app, not the Gateway secret. Paste it in the app's Gateway settings instead; the Gateway secret comes from openclaw gateway auth-token --show on the Gateway host.",
