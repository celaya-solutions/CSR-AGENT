...
const enSettings = {
  ...
  cloudWorkersPage: {
    snapshots: {
      ...
      cancelBuildMessage:
        "Stop this snapshot build and destroy its worker? Zero to Agent waits for provider work and cleanup to finish.",
    ...
    fields: {
      ...
      setup: "Setup command",
      setupHelp: "Optional idempotent shell command run before Zero to Agent is installed.",
  ...
  modelProviders: {
    ...
    profiles: {
      ...
      sourceSaved: "Saved in Zero to Agent",
    },
    apiKey: {
      label: "API key",
    ...
    readiness: {
      ...
      notConfigured: "Choose a provider and verify the model Zero to Agent will use.",
    ...
    logout: {
      ...
      confirm:
        "Remove the saved sign-in for {provider} from Zero to Agent? You can add this account again later.",
    ...
    defaults: {
      ...
      thinkingHelp:
        "Sets the global default for new sessions when no session-specific thinking level is set. Zero to Agent maps unsupported levels to the closest option supported by the selected model.",
      thinkingDefaultHelp:
  ...
  updates: {
    ...
    page: {
      ...
      channelDescription: "Choose which Zero to Agent release track this Gateway follows.",
  ...
  configPage: {
    deviceSettings: {
      appOnly: "These settings are only available inside the Zero to Agent app.",
      ...
      iconStyle: "Dock icon",
      iconStyleHint:
        "Original uses your Mac’s icon style. Other designs follow light/dark mode while Zero to Agent runs.",
      showDockIconHint:
        "Keep Zero to Agent visible in the Dock. When off, windows still show the Dock icon while open.",
      ...
      keepAwakeHint: "Keep the screen awake while Zero to Agent is active.",
      ...
      unattendedDesktopHint:
        "Keep this Mac awake between jobs while it is connected and hosting. Manual lock and logout are still respected; Zero to Agent never unlocks the Mac.",
      ...
      chromeExtensionHint:
        "Prepare the Zero to Agent extension on this Mac, then approve it in Chrome. This does not install on a remote Gateway.",
      chromeExtensionPreparing: "Preparing Chrome…",
      chromeExtensionPending:
        "Native host registered and installation requested. Open Chrome and approve Zero to Agent; restart Chrome if the request has not appeared. Use the Store link if you previously removed it.",
      chromeExtensionStoreRequired:
        "Native host registered. Add Zero to Agent from the Chrome Web Store to finish setup.",
      ...
      chromeExtensionFailed:
        "Setup could not finish. Install the Zero to Agent CLI on this Mac and run openclaw browser extension install for details.",
      ...
      cookieSyncUnavailable: "Cookie sync requires remote mode with an external Zero to Agent CLI.",
      cookieSyncEnabled: "Sync cookies to the remote computer",
      cookieSyncHint:
        "Continuously copy this Mac's logged-in cookies for the domains below into the remote Zero to Agent browser profile. Off by default.",
      domains: "Domains",
      domainsHint:
      ...
      activePresenceHint:
        "Share this Mac's idle duration so Zero to Agent can identify the Mac you used most recently and route node alerts. Never sends keys, pointer positions, app names, or window titles. Requires Accessibility.",
    },
    deviceTalk: {
      title: "This Mac",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint: "Allow Zero to Agent in macOS System Settings > Notifications.",
      iosInstallRequired:
        "On iPhone or iPad, use Share > Add to Home Screen, then open Zero to Agent.",
    ...
    appearance: {
      ...
      fonts: {
        ...
        system: "System",
        previewCaption: "Zero to Agent · A little clarity goes a long way",
        previewProse:
    ...
    sessionStorage: {
      ...
      backupHint:
        "Zero to Agent backups capture archived history with the database. Direct database copies also need the archive files. Missing or damaged archives require recovery from a backup.",
