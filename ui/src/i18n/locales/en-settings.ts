...
const enSettings = {
  ...
  cloudWorkersPage: {
    snapshots: {
      ...
      cancelBuildMessage:
        "Stop this snapshot build and destroy its worker? OpenAgent waits for provider work and cleanup to finish.",
      ...
      migrationHint:
        "Run openagent doctor --fix and follow its provider-cleanup recovery instructions before provisioning workers.",
    },
    ...
    fields: {
      ...
      setup: "Setup command",
      setupHelp: "Optional idempotent shell command run before OpenAgent is installed.",
  ...
  modelProviders: {
    ...
    profiles: {
      ...
      sourceSaved: "Saved in OpenAgent",
    },
    apiKey: {
      label: "API key",
    ...
    readiness: {
      ...
      notConfigured: "Choose a provider and verify the model OpenAgent will use.",
    ...
    logout: {
      ...
      confirm:
        "Remove the saved sign-in for {provider} from OpenAgent? You can add this account again later.",
    ...
    defaults: {
      ...
      thinkingHelp:
        "Sets the global default for new sessions when no session-specific thinking level is set. OpenAgent maps unsupported levels to the closest option supported by the selected model.",
      thinkingDefaultHelp:
  ...
  updates: {
    ...
    page: {
      ...
      channelDescription: "Choose which OpenAgent release track this Gateway follows.",
  ...
  configPage: {
    deviceSettings: {
      appOnly: "These settings are only available inside the OpenAgent app.",
      ...
      iconStyle: "Dock icon",
      iconStyleHint:
        "Original uses your Mac’s icon style. Other designs follow light/dark mode while OpenAgent runs.",
      showDockIconHint:
        "Keep OpenAgent visible in the Dock. When off, windows still show the Dock icon while open.",
      ...
      keepAwakeHint: "Keep the screen awake while OpenAgent is active.",
      ...
      unattendedDesktopHint:
        "Keep this Mac awake between jobs while it is connected and hosting. Manual lock and logout are still respected; OpenAgent never unlocks the Mac.",
      ...
      chromeExtensionHint:
        "Prepare the OpenAgent extension on this Mac, then approve it in Chrome. This does not install on a remote Gateway.",
      chromeExtensionPreparing: "Preparing Chrome…",
      chromeExtensionPending:
        "Native host registered and installation requested. Open Chrome and approve OpenAgent; restart Chrome if the request has not appeared. Use the Store link if you previously removed it.",
      chromeExtensionStoreRequired:
        "Native host registered. Add OpenAgent from the Chrome Web Store to finish setup.",
      ...
      chromeExtensionFailed:
        "Setup could not finish. Install the OpenAgent CLI on this Mac and run openagent browser extension install for details.",
      ...
      cookieSyncUnavailable: "Cookie sync requires remote mode with an external OpenAgent CLI.",
      cookieSyncEnabled: "Sync cookies to the remote computer",
      cookieSyncHint:
        "Continuously copy this Mac's logged-in cookies for the domains below into the remote OpenAgent browser profile. Off by default.",
      domains: "Domains",
      domainsHint:
      ...
      activePresenceHint:
        "Share this Mac's idle duration so OpenAgent can identify the Mac you used most recently and route node alerts. Never sends keys, pointer positions, app names, or window titles. Requires Accessibility.",
    },
    deviceTalk: {
      title: "This Mac",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint: "Allow OpenAgent in macOS System Settings > Notifications.",
      iosInstallRequired: "On iPhone or iPad, use Share > Add to Home Screen, then open OpenAgent.",
    ...
    appearance: {
      ...
      fonts: {
        ...
        system: "System",
        previewCaption: "OpenAgent · A little clarity goes a long way",
        previewProse:
    ...
    sessionStorage: {
      ...
      backupHint:
        "OpenAgent backups capture archived history with the database. Direct database copies also need the archive files. Missing or damaged archives require recovery from a backup.",
