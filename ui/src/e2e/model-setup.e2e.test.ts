  ...
  it("recovers Ollama setup in place after the local server starts", async () => {
    await suite.withPage(
      ...
      async ({ page }) => {
                ...
                },
                {
                  ...
                  step: {
                    ...
                    message: [
                      ...
                      "",
                      "Continue when it is running. Zero to Agent will retry this address.",
                    ].join("\n"),
                  },
                },
                {
        ...
        await page
          .getByText("Continue when it is running. Zero to Agent will retry this address.")
          .waitFor();
