    ...
    async (colorScheme) => {
      ...
      await suite.withPage(
        ...
        async ({ page }) => {
          ...
          await dialog
            .getByText("⬆️ OpenAgent update in progress: restarting.", { exact: true })
            .waitFor();
          ...
          await dialog
            .getByText("✅ OpenAgent updated to 9f3c21a0 (from 11111111).", { exact: true })
            .first()
            .waitFor();
    ...
    async (colorScheme) => {
      ...
      await suite.withPage(
        ...
        async ({ page }) => {
          ...
          const dialog = page.locator("openclaw-modal-dialog");
          await dialog
            .getByText("⚠️ OpenAgent update failed: deps-install-failed.", { exact: true })
            .first()
            .waitFor();
