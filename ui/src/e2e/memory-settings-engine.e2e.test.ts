    ...
    await suite.withPage(
      ...
      async ({ page }) => {
        ...
        await expect
          ...
          .toEqual(["OpenAgent Memory", "Memory LanceDB", "Off"]);
        ...
        await engineGroup.getByRole("radio", { name: "OpenAgent Memory", exact: true }).click();
    ...
    await suite.withPage(
      ...
      async ({ page }) => {
        ...
        await expect
          ...
          .toEqual(["OpenAgent Memory (Unavailable)", "Memory LanceDB", "Off"]);
        await expect
          .poll(() =>
            engineGroup
              .getByRole("radio", { name: "OpenAgent Memory (Unavailable)", exact: true })
