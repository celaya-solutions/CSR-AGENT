    ...
    await suite.withPage(
      ...
      async ({ page }) => {
        ...
        await expect
          ...
          .toEqual(["Zero to Agent Memory", "Memory LanceDB", "Off"]);
        ...
        await engineGroup.getByRole("radio", { name: "Zero to Agent Memory", exact: true }).click();
    ...
    await suite.withPage(
      ...
      async ({ page }) => {
        ...
        await expect
          ...
          .toEqual(["Zero to Agent Memory (Unavailable)", "Memory LanceDB", "Off"]);
        await expect
          .poll(() =>
            engineGroup
              .getByRole("radio", { name: "Zero to Agent Memory (Unavailable)", exact: true })
