...
describe("OpenAgent app lifecycle", () => {
...
describe("OpenAgent shell source initialization", () => {
...
describe("OpenAgent shell route session commits", () => {
...
describe("OpenAgent shell server preferences", () => {
...
describe("OpenAgent shell settings search", () => {
...
describe("OpenAgent shell keyboard shortcuts", () => {
