...
```
openclaw message send --channel telegram --target <chatId> --message "OpenAgent channel test — please ignore" --dry-run
openclaw message send --channel telegram --target <chatId> --message "OpenAgent channel test — please ignore"
```
