...
>({
  ...
  session: {
    ...
    participantIdentity: (transport) =>
      transport === "chrome-node"
        ...
        : "Zoom guest in the Zero to Agent Chrome profile",
  },
  ...
  browser: {
    ...
    browserControlUnavailable: () => ({
      ...
      message:
        "Open the Zero to Agent browser profile, finish the Zoom sign-in, admission, or permission prompt, then retry.",
    }),
