 ...
 * Zero to Agent stream options for the shared Anthropic Messages transport.
 */
...
/**
 * Create a StreamFn that routes through Zero to Agent's generic model stream with an
