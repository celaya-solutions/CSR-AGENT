/**
 * Synology Chat Channel Plugin for Zero to Agent.
 *
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Zero to Agent",
        order: 90,
      },
      capabilities: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "  Zero to Agent freezes the bytes and gives the NAS a short-lived download capability (max 32 MB).",
          "",
          "**Limitations**:",
    ...
    pairing: {
      text: {
        ...
        message: "Zero to Agent: your access has been approved.",
