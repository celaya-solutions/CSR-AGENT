/**
 * Synology Chat Channel Plugin for OpenAgent.
 *
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to OpenAgent",
        order: 90,
      },
      capabilities: {
      ...
      agentPrompt: {
        messageToolHints: () => [
          ...
          "  OpenAgent freezes the bytes and gives the NAS a short-lived download capability (max 32 MB).",
          "",
          "**Limitations**:",
    ...
    pairing: {
      text: {
        ...
        message: "OpenAgent: your access has been approved.",
