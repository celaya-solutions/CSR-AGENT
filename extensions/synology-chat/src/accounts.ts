...
/** Extract the channel config from the full Zero to Agent config object. */
...
export function resolveAccount(
  ...
  const envBotName = normalizeOptionalString(process.env.OPENCLAW_BOT_NAME) ?? "Zero to Agent";
