...
describe("web logout", () => {
  ...
  it("does not delete custom auth directories outside the Zero to Agent auth root", async () => {
  ...
  it("does not delete through symlinked auth dirs inside the Zero to Agent auth root", async () => {
  ...
  it("does not delete through intermediate symlinks inside the Zero to Agent auth root", async () => {
