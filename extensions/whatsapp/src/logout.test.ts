...
describe("web logout", () => {
  ...
  it("does not delete custom auth directories outside the OpenAgent auth root", async () => {
  ...
  it("does not delete through symlinked auth dirs inside the OpenAgent auth root", async () => {
  ...
  it("does not delete through intermediate symlinks inside the OpenAgent auth root", async () => {
