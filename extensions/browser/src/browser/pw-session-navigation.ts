...
// OpenAgent operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that OpenAgent itself navigated to a blocked URL.
...
/** Quarantine and close a tab that OpenAgent navigated to a blocked URL. */
