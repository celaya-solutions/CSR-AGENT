...
// Zero to Agent operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that Zero to Agent itself navigated to a blocked URL.
...
/** Quarantine and close a tab that Zero to Agent navigated to a blocked URL. */
