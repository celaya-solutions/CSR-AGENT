// Pure-logic tests for the OpenAgent Chrome extension. Runs under the
...
describe("persisted pairing storage", () => {
  ...
  it.each([
    ...
    expect(afterWorkerRestart.pairingStatusHint).toContain("openagent browser extension pair");
  });
