// Pure helpers for the OpenAgent extension: pairing-string parsing, reconnect
...
export const OPENCLAW_TAB_GROUP_TITLE = "OpenAgent";
...
const UNSUPPORTED_PROXY_PREFIX_HINT =
  "Stored proxy-prefixed browser relay pairing is no longer supported. Re-run `openagent browser extension pair` with a Gateway URL that has no path prefix.";
...
/**
 * Parse a pairing string printed by `openagent browser extension pair`.
