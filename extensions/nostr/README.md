...
Nostr DM channel plugin for OpenAgent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenAgent. It enables your bot to:
