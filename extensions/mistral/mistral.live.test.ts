...
describeLive("mistral plugin live", () => {
  it("transcribes synthesized speech through the media provider", async () => {
    const phrase = "Testing Zero to Agent Mistral speech to text integration OK.";
  ...
  it("streams realtime STT through the registered transcription provider", async () => {
    ...
    const phrase = "Testing Zero to Agent Mistral realtime transcription integration OK.";
