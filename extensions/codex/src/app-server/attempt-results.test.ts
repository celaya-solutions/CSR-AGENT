...
describe("Codex app-server attempt results", () => {
  ...
  it.each([
    ...
    },
    {
      ...
      message:
        "Codex finished its turn, but Zero to Agent could not finish processing the result. Some work may already have been performed; verify the current state before continuing.",
    },
