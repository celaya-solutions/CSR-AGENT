...
/**
 * Projects Zero to Agent context-engine assemblies into Codex prompt text while
...
const CONTEXT_HEADER = "Zero to Agent assembled context for this turn:";
...
/** Projects assembled Zero to Agent context-engine messages into Codex prompt inputs. */
