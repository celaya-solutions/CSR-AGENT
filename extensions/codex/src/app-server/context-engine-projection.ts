...
/**
 * Projects OpenAgent context-engine assemblies into Codex prompt text while
...
const CONTEXT_HEADER = "OpenAgent assembled context for this turn:";
...
/** Projects assembled OpenAgent context-engine messages into Codex prompt inputs. */
