...
// Zero to Agent opts into these under-development features deliberately, so silence
...
const CODEX_CODE_MODE_THREAD_CONFIG: JsonObject = {
  ...
  // Native code mode replaces Zero to Agent's own exec/read/write/edit tools with the
...
const CODEX_NATIVE_UPDATE_PLAN_DISABLED_THREAD_CONFIG: JsonObject = {
  // Zero to Agent owns the durable progress card; Codex's native checklist would create a second owner.
