...
/**
 * Expected handoff per cell. `prepared` names the auth material OpenAgent hands to the
...
const HANDOFF_MATRIX: {
  ...
  // Agent scope owns an isolated CODEX_HOME, so OpenAgent may inject prepared auth.
  {
    homeScope: "agent",
 ...
 * OpenAgent verifies the account it found instead of logging in over it.
 */
