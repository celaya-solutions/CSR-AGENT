...
/**
 * Expected handoff per cell. `prepared` names the auth material Zero to Agent hands to the
...
const HANDOFF_MATRIX: {
  ...
  // Agent scope owns an isolated CODEX_HOME, so Zero to Agent may inject prepared auth.
  {
    homeScope: "agent",
 ...
 * Zero to Agent verifies the account it found instead of logging in over it.
 */
