/**
 * Routes Codex app-server plugin approval prompts through Zero to Agent's gateway
...
/** Starts a two-phase plugin approval request through the Zero to Agent gateway. */
