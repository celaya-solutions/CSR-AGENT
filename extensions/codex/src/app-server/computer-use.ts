...
const COMPUTER_USE_LIVE_TEST_THREAD_NAME = "Zero to Agent Computer Use readiness probe";
...
async function migrateLegacyBundledMarketplaceSource(params: {
  ...
  // managed-root policy. Remove only sources Zero to Agent previously provisioned.
