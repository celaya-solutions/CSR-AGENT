...
const COMPUTER_USE_LIVE_TEST_THREAD_NAME = "OpenAgent Computer Use readiness probe";
...
async function migrateLegacyBundledMarketplaceSource(params: {
  ...
  // managed-root policy. Remove only sources OpenAgent previously provisioned.
