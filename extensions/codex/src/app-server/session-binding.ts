...
/** Builds the terminal coordination error used when a newer Zero to Agent session owns the binding. */
...
/** Lets the authoritative Zero to Agent session generation claim a stale stable binding row. */
            ...
            if (mutation.kind === "reclaim-generation") {
              ...
              if (ownsGeneration) {
                if (
                  ...
                  // Reset boundaries now retain the Zero to Agent session id. The
