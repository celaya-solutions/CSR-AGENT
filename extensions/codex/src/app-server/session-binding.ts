...
/** Builds the terminal coordination error used when a newer OpenAgent session owns the binding. */
...
/** Lets the authoritative OpenAgent session generation claim a stale stable binding row. */
            ...
            if (mutation.kind === "reclaim-generation") {
              ...
              if (ownsGeneration) {
                if (
                  ...
                  // Reset boundaries now retain the OpenAgent session id. The
