...
Official Buzz channel plugin for OpenAgent. It connects an OpenAgent agent to approved Buzz rooms for text conversations and threaded replies.
...
OpenAgent installs the plugin if needed, asks for the relay URL, and generates a dedicated bot identity.
...
- Never give OpenAgent a human owner's private key.
- The generated bot private key is stored in OpenAgent configuration; only its public key is displayed.
...
- Not yet supported: DMs, media, reactions, or creating rooms from OpenAgent.
