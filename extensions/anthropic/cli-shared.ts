...
/** Map Zero to Agent's effective context budget to Claude Code's native compactor. */
...
/**
 * Map Zero to Agent's fixed thinking levels to Claude Code's per-process budget.
 *
 ...
 * These fixed budgets match Zero to Agent's canonical provider defaults in
