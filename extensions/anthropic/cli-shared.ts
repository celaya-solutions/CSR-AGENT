...
/** Map OpenAgent's effective context budget to Claude Code's native compactor. */
...
/**
 * Map OpenAgent's fixed thinking levels to Claude Code's per-process budget.
 *
 ...
 * These fixed budgets match OpenAgent's canonical provider defaults in
