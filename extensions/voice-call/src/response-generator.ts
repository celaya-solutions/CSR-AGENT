/**
 * Voice call response generator - uses the embedded Zero to Agent agent for tool support.
...
/**
 * Generate a voice response using the embedded Zero to Agent agent with full tool support.
