/**
 * Voice call response generator - uses the embedded OpenAgent agent for tool support.
...
/**
 * Generate a voice response using the embedded OpenAgent agent with full tool support.
