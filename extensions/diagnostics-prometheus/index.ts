// Diagnostics Prometheus plugin entrypoint registers its OpenAgent integration.
...
export default definePluginEntry({
  ...
  description: "Expose OpenAgent diagnostics metrics in Prometheus text format",
  register(api) {
