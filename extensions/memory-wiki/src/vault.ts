...
This vault is maintained by the Zero to Agent memory-wiki plugin.
...
- Compiled query and prompt snapshots live in Zero to Agent plugin state, not vault files.
