...
/**
 * Provenance marker appended to every Zero to Agent-injected inbound context header
...
/**
 * Matches JSON blobs that look like Zero to Agent transport envelope metadata.
...
/**
 * Returns true if `text` looks like it contains Zero to Agent-injected envelope or
...
/**
 * Strips Zero to Agent-injected envelope metadata from a user message so that only
