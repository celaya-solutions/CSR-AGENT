...
/**
 * Provenance marker appended to every OpenAgent-injected inbound context header
...
/**
 * Matches JSON blobs that look like OpenAgent transport envelope metadata.
...
/**
 * Returns true if `text` looks like it contains OpenAgent-injected envelope or
...
/**
 * Strips OpenAgent-injected envelope metadata from a user message so that only
