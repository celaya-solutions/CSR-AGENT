# OpenAgent Kimi Coding Provider

Official OpenAgent provider plugin for Kimi Coding.
...
Kimi can return HTTP 403 when a weekly usage limit is exhausted. OpenAgent treats
