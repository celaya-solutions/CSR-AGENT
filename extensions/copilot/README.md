# GitHub Copilot agent runtime (Zero to Agent plugin)

External Zero to Agent plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. Zero to Agent remains the default embedded runtime.
...
- Minimum Zero to Agent host: `2026.5.28`
