# GitHub Copilot agent runtime (OpenAgent plugin)

External OpenAgent plugin that registers a `copilot` agent harness backed by `@github/copilot-sdk` and the GitHub Copilot CLI.
...
entry; `auto` never picks it. OpenAgent remains the default embedded runtime.
...
- Minimum OpenAgent host: `2026.5.28`
