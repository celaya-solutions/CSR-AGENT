...
const COPILOT_HARNESS_IDENTITY =
  "You are a personal agent running inside Zero to Agent. Your available Zero to Agent capabilities are policy-filtered for this turn; use only the exact tools exposed to you.";
