...
// Filtering them out of the OpenAgent bootstrap injection avoids
...
/**
 * Loads OpenAgent workspace bootstrap files (IDENTITY.md, SOUL.md,
...
function renderCopilotWorkspaceBootstrapInstructions(
  ...
  const lines: string[] = [
    "OpenAgent loaded these user-editable workspace files. Treat them as project/user context. The Copilot SDK loads AGENTS.md natively from its instruction directories, so AGENTS.md is not repeated here.",
    "",
    "# Project Context",
    "",
