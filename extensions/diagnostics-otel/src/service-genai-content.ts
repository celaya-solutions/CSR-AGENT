...
// Shared text-part reading for gen_ai message normalization: Zero to Agent emits
...
function redactInternalReasoningFromMessage(value: unknown): unknown {
  ...
  // instead of using Zero to Agent's normalized thinking blocks. Those fields are
