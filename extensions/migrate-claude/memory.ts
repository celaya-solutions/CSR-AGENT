...
async function assertSafeMemoryDestination(
  ...
  if (
    ...
    throw new Error(
      "Claude Code auto-memory source and Zero to Agent import destination must be separate directories.",
    );
  }
}
        ...
        createMigrationItem({
          ...
          reason: targetNotRegular
            ...
            : targetConflict
              ...
              : undefined,
          message: "Copy Claude Code auto-memory Markdown into the Zero to Agent memory index.",
          details: {
