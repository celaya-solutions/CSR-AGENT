/**
 * Amazon Bedrock Converse streaming runtime. It maps Zero to Agent messages/tools,
...
// Zero to Agent synthesizes these caps when the provider's real output limit is unknown.
...
/** Stream a Bedrock Converse request from the generic Zero to Agent stream options. */
