/**
 * Amazon Bedrock Converse streaming runtime. It maps OpenAgent messages/tools,
...
// OpenAgent synthesizes these caps when the provider's real output limit is unknown.
...
/** Stream a Bedrock Converse request from the generic OpenAgent stream options. */
