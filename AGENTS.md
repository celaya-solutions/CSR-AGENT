...
- **Live channels:** the owning scoped guide and permitted proof workflow. Telegram claims require Test Server userbot proof; platform claims require the relevant real device/platform evidence. This build ships no native apps.
