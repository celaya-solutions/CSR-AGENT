...
final class ShareComposeView: UIView, UITextViewDelegate {
    ...
    func apply(_ status: ShareComposeStatus) {
        ...
        case .sending:
            self.showFooter(
                text: NSLocalizedString("Sending to OpenAgent gateway…", comment: "Share extension sending status"),
                icon: nil,
                spinning: true)
        case .sent:
            self.showFooter(
                text: NSLocalizedString("Sent to OpenAgent.", comment: "Share extension success status"),
    ...
    private func configureSubviews() {
        ...
        self.titleLabel.text = "OpenAgent"
    ...
    private static func makeSendConfiguration() -> UIButton.Configuration {
        ...
        configuration.attributedTitle = self.attributedTitle(
            NSLocalizedString("Send to OpenAgent", comment: "Share extension send action"),
            style: .headline)
