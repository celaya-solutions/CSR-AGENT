...
Maintenance update for the current OpenAgent release.
...
OpenAgent is now available on iPhone.

Connect to your OpenAgent Gateway to chat with your assistant, use realtime Talk mode, review approvals, share content from iOS, and bring device capabilities like camera, location, screen, and notifications into your private automation workflows.
...
Maintenance update for the current OpenAgent development release.
...
First App Store release of OpenAgent for iPhone. Pair with your OpenAgent Gateway to use chat, voice, sharing, and device actions from iOS.
