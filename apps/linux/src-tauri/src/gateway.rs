...
impl GatewaySnapshot {
    pub fn unconfigured() -> Self {
        Self {
            ...
            detail: Some("Choose where your OpenAgent Gateway should run.".to_string()),
        }
    }
    ...
    pub fn missing_cli() -> Self {
        Self {
            ...
            detail: Some("Install the OpenAgent CLI to continue.".to_string()),
        }
    }
...
fn unsupported_dashboard_integration() -> String {
    "The installed OpenAgent CLI does not support the desktop dashboard integration. \
