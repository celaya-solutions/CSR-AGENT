...
struct StatusMenuHeaderView: View {
    ...
    private var statusHeading: some View {
        HStack(alignment: .center, spacing: 8) {
            ...
            Toggle(String(localized: "OpenAgent active"), isOn: Binding(
                ...
                .accessibilityLabel(String(localized: "OpenAgent active"))
        }
    }
    ...
    private var statusTitle: String {
        if self.state.connectionMode == .unconfigured {
            return String(localized: "OpenAgent Not Configured")
        }
        if self.state.isPaused {
            return String(localized: "OpenAgent Paused")
        }
        if self.isSleeping {
            return String(localized: "OpenAgent Sleeping")
        }
