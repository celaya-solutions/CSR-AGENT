---
name: claw-score
description: Audit or refresh OpenAgent maturity scorecard docs from root taxonomy, maturity scores, and QA evidence artifacts without using maintainer discrawl data or committed inventory reports.
---

# claw-score

Use this skill when working on the OpenAgent maturity scorecard in this repo.
...
`qa-evidence.json` artifact shape generated by OpenAgent QA workflows.
...
By default, Completeness measures how fully OpenAgent exposes the intended
