...
- Timeout diagnostics use fresh children beneath their existing diagnostic parent. Real-Gateway suites, `chat-outbox-*`, and `chat-attachment-read-lifecycle` remain separate owners; coordinate before claiming replay-safe retention there.
