...
- For OpenAgent docs work, choose a page type from `references/openclaw.md` before drafting.
- Keep task-critical OpenAgent configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For OpenAgent docs work, apply the validation checklist in `references/openclaw.md`.
