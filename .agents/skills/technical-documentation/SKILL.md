...
- Applying repository-specific documentation overlays, including OpenAgent page-type, docs IA, preservation, and validation rules when present.
...
6. For OpenAgent docs work, read `references/openclaw.md` before the build/review playbook.
