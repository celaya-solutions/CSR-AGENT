---
summary: "How to contribute to the Zero to Agent threat model"
...
Contributors to the threat model are recognized in the threat model acknowledgments, release notes, and the Zero to Agent security hall of fame for significant contributions.
