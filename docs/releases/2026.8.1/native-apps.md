...
Sharing into OpenAgent now previews supported attachments and shows their progress from preparation through completion or failure. Completed shares in this release support text, links, or one to three images, and Send stays unavailable when an unsupported, excess, or unloadable attachment would otherwise be left out.
...
- Refresh iOS and Watch icons with the current OpenAgent mascot [#101411](https://github.com/openclaw/openclaw/pull/101411)
...
- Align the Android launcher icon with the OpenAgent favicon [#101423](https://github.com/openclaw/openclaw/pull/101423)
...
- fix(macos): allow dragging the OpenAgent panel header [#132288](https://github.com/openclaw/openclaw/pull/132288)
