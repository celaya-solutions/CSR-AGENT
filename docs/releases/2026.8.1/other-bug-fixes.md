...
- Validate shared SQLite state before Zero to Agent mutates it [#104952](https://github.com/openclaw/openclaw/pull/104952)
...
- Restore Zero to Agent guidance to Copilot agent turns [#125997](https://github.com/openclaw/openclaw/pull/125997)
...
[Process output](/tools/exec) also stays in the order Zero to Agent observed it, completion remains attached to the exact process that finished, and polling says when earlier output was omitted. The full history remains available through paged process logs rather than one response that can grow without bound.
...
- Keep truncated Unicode text valid across Zero to Agent surfaces [#102823](https://github.com/openclaw/openclaw/pull/102823)
...
- Register the local audio check in Zero to Agent Doctor [#104242](https://github.com/openclaw/openclaw/pull/104242)
- Restore local audio information in Zero to Agent Doctor [#104281](https://github.com/openclaw/openclaw/pull/104281)
...
- Block agent SQLite commands from opening live Zero to Agent state [#123816](https://github.com/openclaw/openclaw/pull/123816)
