...
- Validate shared SQLite state before OpenAgent mutates it [#104952](https://github.com/openclaw/openclaw/pull/104952)
...
- Restore OpenAgent guidance to Copilot agent turns [#125997](https://github.com/openclaw/openclaw/pull/125997)
...
[Process output](/tools/exec) also stays in the order OpenAgent observed it, completion remains attached to the exact process that finished, and polling says when earlier output was omitted. The full history remains available through paged process logs rather than one response that can grow without bound.
...
- Keep truncated Unicode text valid across OpenAgent surfaces [#102823](https://github.com/openclaw/openclaw/pull/102823)
...
- Register the local audio check in OpenAgent Doctor [#104242](https://github.com/openclaw/openclaw/pull/104242)
- Restore local audio information in OpenAgent Doctor [#104281](https://github.com/openclaw/openclaw/pull/104281)
...
- Block agent SQLite commands from opening live OpenAgent state [#123816](https://github.com/openclaw/openclaw/pull/123816)
