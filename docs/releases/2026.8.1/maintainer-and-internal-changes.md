...
description: "The 6,364 changes that primarily affect the people who build and maintain OpenAgent: release and CI work, tests, internal refactors, and documentation maintenance."
---

Another 6,364 changes in this release primarily affect the people who build and maintain OpenAgent. They cover [release and CI work](/reference/RELEASING), tests, internal refactors, documentation maintenance, and narrow fixes that sit outside the user-facing product areas of this release.
...
- fix(qa): OpenAgent harness planning check fails after progress-card migration [#129143](https://github.com/openclaw/openclaw/pull/129143)
...
- Attribute published packages and docs to the Celaya Solutions [#112633](https://github.com/openclaw/openclaw/pull/112633)
...
- docs(start): add Why OpenAgent enterprise architecture page [#130709](https://github.com/openclaw/openclaw/pull/130709)
- docs(start): add architecture diagrams to Why OpenAgent [#130776](https://github.com/openclaw/openclaw/pull/130776)
- docs(start): human introduction for Why OpenAgent [#130812](https://github.com/openclaw/openclaw/pull/130812)
- docs(start): restructure Why OpenAgent intro into a question-answer flow [#130874](https://github.com/openclaw/openclaw/pull/130874)
- docs(start): bridge paragraph for personal readers on Why OpenAgent [#131105](https://github.com/openclaw/openclaw/pull/131105)
