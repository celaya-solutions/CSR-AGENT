...
description: "The 6,364 changes that primarily affect the people who build and maintain Zero to Agent: release and CI work, tests, internal refactors, and documentation maintenance."
---

Another 6,364 changes in this release primarily affect the people who build and maintain Zero to Agent. They cover [release and CI work](/reference/RELEASING), tests, internal refactors, documentation maintenance, and narrow fixes that sit outside the user-facing product areas of this release.
...
- fix(qa): Zero to Agent harness planning check fails after progress-card migration [#129143](https://github.com/openclaw/openclaw/pull/129143)
...
- docs(start): add Why Zero to Agent enterprise architecture page [#130709](https://github.com/openclaw/openclaw/pull/130709)
- docs(start): add architecture diagrams to Why Zero to Agent [#130776](https://github.com/openclaw/openclaw/pull/130776)
- docs(start): human introduction for Why Zero to Agent [#130812](https://github.com/openclaw/openclaw/pull/130812)
- docs(start): restructure Why Zero to Agent intro into a question-answer flow [#130874](https://github.com/openclaw/openclaw/pull/130874)
- docs(start): bridge paragraph for personal readers on Why Zero to Agent [#131105](https://github.com/openclaw/openclaw/pull/131105)
