...
read_when:
  - You want OpenAgent to learn reusable procedures from completed conversations
...
After substantial work, OpenAgent can run one detached background review to find
...
OpenAgent records where the completed turn ends, then reads its full model context
