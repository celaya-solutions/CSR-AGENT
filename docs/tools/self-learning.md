...
read_when:
  - You want Zero to Agent to learn reusable procedures from completed conversations
...
After substantial work, Zero to Agent can run one detached background review to find
...
Zero to Agent records where the completed turn ends, then reads its full model context
