...
Preview cards appear only for HTTP(S) page URLs when OpenAgent can identify the
...
preserve the active Chrome tab when OpenAgent can verify that the attached browser
