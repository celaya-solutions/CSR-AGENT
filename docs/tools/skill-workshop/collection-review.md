...
Zero to Agent tool set, including Claude CLI. These CLI reviews retain the host-selected instruction snapshot;
Workshop skill contents remain review material. Zero to Agent carries the Workshop
