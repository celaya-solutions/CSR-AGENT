...
OpenAgent passes cancellation to fallback providers. Providers that honor the
...
connection cleanup, OpenAgent rejects the call instead of returning success or
...
In this mode, OpenAgent still applies hostname-based SSRF checks before sending
