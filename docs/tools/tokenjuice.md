...
title: "Tokenjuice"
read_when:
  - You want shorter `exec` or `bash` tool results in OpenAgent
...
Today this applies to OpenAgent embedded runs and OpenAgent dynamic tools in the Codex
app-server harness. Tokenjuice hooks OpenAgent's tool-result middleware and
