...
title: "Tokenjuice"
read_when:
  - You want shorter `exec` or `bash` tool results in Zero to Agent
...
Today this applies to Zero to Agent embedded runs and Zero to Agent dynamic tools in the Codex
app-server harness. Tokenjuice hooks Zero to Agent's tool-result middleware and
