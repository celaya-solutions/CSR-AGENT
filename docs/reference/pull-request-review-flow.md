---
summary: "How Barnacle and ClawSweeper feedback helps move Zero to Agent pull requests through review."
read_when:
...
This page explains the review flow after you open or update a Zero to Agent pull
...
ClawSweeper is the AI-assisted review and maintenance bot for Zero to Agent
...
Zero to Agent also uses separate stale automation. Unassigned issues and PRs can be
