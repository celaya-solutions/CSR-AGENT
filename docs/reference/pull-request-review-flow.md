---
summary: "How Barnacle and ClawSweeper feedback helps move OpenAgent pull requests through review."
read_when:
...
This page explains the review flow after you open or update an OpenAgent pull
...
ClawSweeper is the AI-assisted review and maintenance bot for OpenAgent
...
OpenAgent also uses separate stale automation. Unassigned issues and PRs can be
