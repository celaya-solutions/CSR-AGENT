...
| 2       | Metadata-only message audit events                                                                                                                                                                                                                                                                                              | `v2026.7.2-beta.1`  |
| 3       | `STRICT` tables and schema-drift hardening                                                                                                                                                                                                                                                                                      | `v2026.7.2-beta.2`  |
| 4       | Session watch provenance replaces encoded sentinel rows                                                                                                                                                                                                                                                                         | Unreleased          |
| 5       | Durable cloud-worker result references on pending workspace fences                                                                                                                                                                                                                                                              | `v2026.7.2-beta.4`  |
| 6       | Every committed shared-state table becomes part of the canonical runtime schema                                                                                                                                                                                                                                                 | `v2026.7.2-beta.5`  |
