...
| ------- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| 1       | Initial per-agent store                                                                                                       | `v2026.5.30-beta.1`, stable through `v2026.7.1` |
| 2       | Memory index identity                                                                                                         | `v2026.7.2-beta.1`                              |
| 4       | Sessions and transcripts moved into SQLite                                                                                    | `v2026.7.2-beta.1`                              |
| 5-6     | Terminal freshness and state lifecycle                                                                                        | `v2026.7.2-beta.1`                              |
| 7       | Per-entry lifecycle status projection                                                                                         | `v2026.7.2-beta.1`                              |
| 8       | Per-transcript session provenance                                                                                             | `v2026.7.2-beta.2`                              |
| 9       | `STRICT` tables                                                                                                               | `v2026.7.2-beta.2`                              |
| 10      | Materialized active transcript paths                                                                                          | Unreleased                                      |
| 11      | Durable delivery, conversation addresses, and heartbeat outcomes                                                              | Unreleased                                      |
...
| 17      | Tenant-free per-agent lease table retired after the last writer and routing arm were removed                                  | Unreleased                                      |
| 18      | Canonical participant identity namespaces and explicit unknown historical input times in the existing session-owned aggregate | Unreleased                                      |
...
[`openagent update repair`](/cli/update/repair-and-recovery#update-repair)
