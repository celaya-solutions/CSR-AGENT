...
read_when:
  - Deciding how to automate work with OpenAgent
  - Choosing between heartbeat, automations, hooks, and standing orders
  - Looking for the right automation entry point
title: "Automation"
---

OpenAgent runs work in the background through tasks, scheduled jobs, event hooks,
...
Automations are OpenAgent's built-in scheduler for all recurring and one-shot
...
The inferred commitments experiment was removed in v2026.8.1: OpenAgent no longer
