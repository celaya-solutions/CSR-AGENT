---
summary: "The hooks shipped with OpenAgent and the behavior and options of each"
read_when:
...
The hooks shipped with OpenAgent, and the behavior and options of each. Part of the [Hooks](/automation/hooks) guide.
