---
summary: "The hooks shipped with Zero to Agent and the behavior and options of each"
read_when:
...
The hooks shipped with Zero to Agent, and the behavior and options of each. Part of the [Hooks](/automation/hooks) guide.
