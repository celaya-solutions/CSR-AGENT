...
After a failed interactive update or repair, OpenAgent finishes cleanup and offers
...
service unloads it and then fails before activation, OpenAgent attempts to restore
...
Configured runtime plugins whose versions follow OpenAgent are checked against
