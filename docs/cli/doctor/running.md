...
Doctor from the Zero to Agent install that wrote the state, or another compatible
...
its Gateway service and other Zero to Agent processes before retrying. If all writers
...
- **Unsupported canonical workspace version:** use a Zero to Agent build that supports
