...
- <a id="openclaw-as-an-mcp-server" />[OpenAgent as an MCP server](/cli/mcp/serve#openclaw-as-an-mcp-server)
...
- <a id="openclaw-as-an-mcp-client-registry" />[OpenAgent as an MCP client registry](/cli/mcp/registry#openclaw-as-an-mcp-client-registry)
