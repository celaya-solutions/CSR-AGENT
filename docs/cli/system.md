---
summary: "CLI reference for `openagent system` (system events, heartbeat, presence)"
read_when:
...
openagent system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$OPENCLAW_GATEWAY_TOKEN"
openagent system heartbeat enable
openagent system heartbeat last
openagent system presence
```
