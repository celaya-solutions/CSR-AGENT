...
read_when:
  - You want to chat with Zero to Agent for setup or repair
...
`openclaw setup` opens an interactive Zero to Agent chat. On a fresh system, it
...
3. With no routing option, a configured interactive system opens Zero to Agent. A
...
In guided mode, `--workspace <dir>` is the workspace proposed to Zero to Agent;
...
entry for the same inference-gated Zero to Agent assistant.
...
| Flag                           | Description                                                                                          |
| ------------------------------ | ---------------------------------------------------------------------------------------------------- |
| `-m, --message <text>`         | Run one Zero to Agent request.                                                                       |
...
| `--json`                       | Configured system: Zero to Agent overview. Onboarding route: onboarding summary.                     |
