---
summary: "Scaffold, build, validate, and pack a Zero to Agent plugin with `openclaw plugins init`"
...
argument is the plugin id; `--name` sets the display name. Zero to Agent uses the
