...
summary: "Detailed reference for the product areas and checks behind the Zero to Agent maturity scorecard."
---
...
<Tabs>
  <Tab title="Core">
    ...
    <a className="maturity-surface-link" href="#openclaw-app-sdk">
      <span className="maturity-surface-title">Zero to Agent App SDK</span>
...
<AccordionGroup>
  ...
  <Accordion title="Zero to Agent App SDK - M2 Alpha - 6 areas">
    <a id="openclaw-app-sdk" />

    Zero to Agent App SDK is a distinct external app contract separate from Gateway runtime and Plugin SDK. Current scoring shows a real `@openclaw/sdk` path with gaps around public packaging, auto-discovery, approvals, helpers, and compatibility.
...
<AccordionGroup>
  ...
  <Accordion title="Linux companion app - M3 Beta - 5 areas">
    ...
    [Linux](/platforms/linux), [Zero to Agent](/start/openclaw), [Doctor](/gateway/doctor)
