---
summary: "Backstory and lore of OpenAgent for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "OpenAgent lore"
---

# The Lore of OpenAgent 🦞📖
...
On January 30, 2026, the lobster molted one more time into its final form: **OpenAgent**.
...
The **Moltiverse** is the community and ecosystem around OpenAgent: a space
...
**The Fake Developers:** scammers created fake GitHub profiles claiming to be "Head of Engineering at OpenAgent" to promote pump-and-dump tokens.
...
Moltbot never quite rolled off the tongue. So at 4am GMT, the team gathered again for **The Great OpenAgent Migration**.

In just 3 hours:

- GitHub repository renamed to OpenClaw
- X handle `@openclaw` secured, with a gold checkmark
- npm packages released under the new name
- Docs moved to their own domain
...
**Clawd → Moltbot → OpenAgent.** _The lobster has molted into its final form._
