---
summary: "Backstory and lore of Zero to Agent for context and tone"
read_when:
  - Writing docs or UX copy that reference lore
title: "Zero to Agent lore"
---

# The Lore of Zero to Agent 🦞📖
...
On January 30, 2026, the lobster molted one more time into its final form: **Zero to Agent**.
...
The **Moltiverse** is the community and ecosystem around Zero to Agent: a space
...
**The Fake Developers:** scammers created fake GitHub profiles claiming to be "Head of Engineering at Zero to Agent" to promote pump-and-dump tokens.
...
Moltbot never quite rolled off the tongue. So at 4am GMT, the team gathered again for **The Great Zero to Agent Migration**.
...
**Clawd → Moltbot → Zero to Agent.** _The lobster has molted into its final form._
