---
summary: "Get Zero to Agent installed and run your first chat in minutes."
read_when:
...
Install Zero to Agent, run onboarding, and chat with your AI assistant in about 5
...
usable AI access is already available: Zero to Agent
...
<Accordion title="Advanced: environment variables">
  If you run Zero to Agent as a service account or want custom paths:
