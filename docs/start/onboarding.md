---
summary: "First-run setup flow for Zero to Agent (macOS app)"
read_when:
...
<Tip>
Need the app first? [Download Zero to Agent for macOS](/platforms/macos#download),
then return here for first-run setup.
</Tip>

<Steps>
<Step title="Approve macOS warning">
The first time you open Zero to Agent.app, macOS asks you to approve a downloaded
app. Click **Open** to continue.

<Frame>
<img src="/assets/macos-onboarding/01-macos-warning.jpeg" alt="macOS dialog that asks whether to open the downloaded Zero to Agent app" />
</Frame>
</Step>
<Step title="Approve find local networks">
macOS then asks whether Zero to Agent may find devices on your local network.
Click **Allow**. The app uses this to reach a Gateway on another machine.

<Frame>
<img src="/assets/macos-onboarding/02-local-networks.jpeg" alt="macOS dialog that asks whether Zero to Agent may find devices on the local network" />
</Frame>
</Step>
...
<img src="/assets/macos-onboarding/03-security-notice.png" alt="Zero to Agent welcome screen with the security notice" />
</Frame>

Security trust model:

- By default, Zero to Agent is a personal agent: one trusted operator boundary.
...
Select the connection you want before Zero to Agent saves any returned credential and runs one
...
The provider picker is built from installed manifests and Zero to Agent's official
...
alias, Zero to Agent tests and saves the provider's canonical model name while
...
onboarding in the dashboard. Zero to Agent helps configure the remaining workspace,
...
during the agent's first real turn. Zero to Agent remains available later under
**Settings → Zero to Agent**.
</Step>
</Steps>
