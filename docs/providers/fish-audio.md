...
read_when:
  - You want Fish Audio text-to-speech in Zero to Agent
  - You want expressive or cloned voices with Fish Audio
  - You want local Fish S2 Pro speech in macOS Talk mode
title: "Fish Audio"
---

Zero to Agent supports Fish Audio in two distinct ways:
...
notes, and raw PCM at 8 kHz for telephony. For Discord voice, Zero to Agent consumes
...
Fish voice library. Zero to Agent lists your voices first, then a bounded page of
...
The first utterance downloads about 6.8 GB of model and codec data. Zero to Agent
