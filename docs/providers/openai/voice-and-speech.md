...
<AccordionGroup>
  <Accordion title="Speech synthesis (TTS)">
    ...
    `extraBody` is merged into `/audio/speech` request JSON after Zero to Agent's
  ...
  <Accordion title="Speech-to-text">
    ...
    Zero to Agent's media-understanding transcription surface.
  ...
  <Accordion title="Realtime voice">
    ...
    falls back to the Zero to Agent ChatGPT OAuth subscription profile. The
    ...
    configured Zero to Agent agent. It can listen while speaking; interrupting speech
    ...
    subscription route. Its browser and Gateway-relay WebRTC try the Zero to Agent ChatGPT
    ...
    The shared Zero to Agent agent conversation supplies room context, while each
    ...
    Current Platform-key sessions accept `marin` and `cedar`. Zero to Agent defaults
    ...
    fallback, routes sideband delegations through the configured Zero to Agent
    ...
    direct socket enables Discord voice and Voice Call/telephony; Zero to Agent
    ...
    and delegation mode at startup. Zero to Agent exposes the
