---
summary: "Use OpenAI via API keys or Codex subscription in Zero to Agent"
read_when:
  - You want to use OpenAI models in Zero to Agent
...
Zero to Agent uses one provider id, `openai`, for both direct API-key auth and
...
facts decide whether Zero to Agent may select the bundled Codex app-server runtime
...
- <a id="embedded-openclaw-translation" />[Embedded Zero to Agent translation](/providers/openai/setup#embedded-openclaw-translation)
...
- <a id="openclaw-feature-coverage" />[Zero to Agent feature coverage](/providers/openai/coverage-and-cost#openclaw-feature-coverage)
