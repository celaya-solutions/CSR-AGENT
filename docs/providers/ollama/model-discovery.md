---
summary: "How OpenAgent discovers Ollama models implicitly, plus narrow smoke tests"
read_when:
  - You want to know which models OpenAgent discovers and how
...
defined, OpenAgent discovers models from `http://127.0.0.1:11434`:
...
hand-written `models.json` entry; OpenAgent resolves it live. For signed-in
...
provider and `/api/tags` is unreachable, OpenAgent records that run as
