---
summary: "Azure AI Speech text-to-speech for OpenAgent replies"
read_when:
...
Azure Speech is a bundled Azure AI Speech text-to-speech provider. OpenAgent
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. OpenAgent synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; OpenAgent derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. OpenAgent
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled OpenAgent providers.
  </Card>
