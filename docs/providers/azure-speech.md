---
summary: "Azure AI Speech text-to-speech for Zero to Agent replies"
read_when:
...
Azure Speech is a bundled Azure AI Speech text-to-speech provider. Zero to Agent
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Zero to Agent synthesizes the audio
...
<AccordionGroup>
  <Accordion title="Authentication">
    ...
    is sent as `Ocp-Apim-Subscription-Key`; Zero to Agent derives
  ...
  <Accordion title="Audio outputs">
    ...
    `ogg-24khz-16bit-mono-opus`, and `riff-24khz-16bit-mono-pcm`. Zero to Agent
...
<CardGroup cols={2}>
  ...
  <Card title="Providers" href="/providers" icon="grid">
    All bundled Zero to Agent providers.
  </Card>
