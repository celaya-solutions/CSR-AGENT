...
read_when:
  - You want to use Featherless AI with Zero to Agent
...
OpenAI-compatible API. Zero to Agent installs Featherless as an official external
...
documents native tool calling for the Qwen 3 family. Zero to Agent configures its
...
Zero to Agent deliberately does not copy Featherless's full public model index into
