...
read_when:
  - You want to use Featherless AI with OpenAgent
...
OpenAI-compatible API. OpenAgent installs Featherless as an official external
...
documents native tool calling for the Qwen 3 family. OpenAgent configures its
...
OpenAgent deliberately does not copy Featherless's full public model index into
