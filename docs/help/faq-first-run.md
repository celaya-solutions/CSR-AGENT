...
- <a id="recommended-way-to-install-and-set-up-openclaw" />[Recommended way to install and set up OpenAgent](/help/faq-first-run/quick-start#recommended-way-to-install-and-set-up-openclaw)
...
- <a id="how-do-i-install-openclaw-on-linux" />[How do I install OpenAgent on Linux?](/help/faq-first-run/quick-start#how-do-i-install-openclaw-on-linux)
- <a id="how-do-i-install-openclaw-on-a-vps" />[How do I install OpenAgent on a VPS?](/help/faq-first-run/quick-start#how-do-i-install-openclaw-on-a-vps)
...
- <a id="can-i-ask-openclaw-to-update-itself" />[Can I ask OpenAgent to update itself?](/help/faq-first-run/quick-start#can-i-ask-openclaw-to-update-itself)
...
- <a id="why-does-openclaw-still-mention-legacy-openai-codex-prefix" />[Why does OpenAgent still mention legacy OpenAI Codex prefix?](/help/faq-first-run/providers-and-hosting#why-does-openclaw-still-mention-legacy-openai-codex-prefix)
...
- <a id="if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro" />[If I buy a Mac mini to run OpenAgent, can I connect it to my MacBook Pro?](/help/faq-first-run/providers-and-hosting#if-i-buy-a-mac-mini-to-run-openclaw-can-i-connect-it-to-my-macbook-pro)
...
- <a id="can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances" />[Can multiple people use one WhatsApp number with different OpenAgent instances?](/help/faq-first-run/providers-and-hosting#can-multiple-people-use-one-whatsapp-number-with-different-openclaw-instances)
...
- <a id="how-important-is-it-to-run-openclaw-on-a-dedicated-machine" />[How important is it to run OpenAgent on a dedicated machine?](/help/faq-first-run/providers-and-hosting#how-important-is-it-to-run-openclaw-on-a-dedicated-machine)
...
- <a id="can-i-run-openclaw-in-a-vm-and-what-are-the-requirements" />[Can I run OpenAgent in a VM and what are the requirements?](/help/faq-first-run/providers-and-hosting#can-i-run-openclaw-in-a-vm-and-what-are-the-requirements)
