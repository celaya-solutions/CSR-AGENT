---
summary: "How OpenAgent validates update paths, package migrations, and plugin install/update behavior"
read_when:
  - Changing OpenAgent update, doctor, package acceptance, or plugin install behavior
