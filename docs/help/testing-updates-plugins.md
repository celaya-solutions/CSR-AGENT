---
summary: "How Zero to Agent validates update paths, package migrations, and plugin install/update behavior"
read_when:
  - Changing Zero to Agent update, doctor, package acceptance, or plugin install behavior
