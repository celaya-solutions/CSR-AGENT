---
summary: "Frequently asked questions about OpenAgent setup, configuration, and usage"
read_when:
...
- <a id="what-is-openclaw%3F" /><a id="what-is-openclaw" />[What is OpenAgent?](/help/faq/what-is-openclaw#what-is-openclaw)
- <a id="what-is-openclaw-in-one-paragraph" />[What is OpenAgent, in one paragraph?](/help/faq/what-is-openclaw#what-is-openclaw-in-one-paragraph)
- <a id="can-my-team-share-one-openclaw" />[Can my team share one OpenAgent?](/help/faq/what-is-openclaw#can-my-team-share-one-openclaw)
...
- <a id="what-are-the-top-five-everyday-use-cases-for-openclaw" />[What are the top five everyday use cases for OpenAgent?](/help/faq/what-is-openclaw#what-are-the-top-five-everyday-use-cases-for-openclaw)
- <a id="can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas" />[Can OpenAgent help with lead gen, outreach, ads, and blogs for a SaaS?](/help/faq/what-is-openclaw#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
- <a id="is-openclaw-owned-by-openai" />[Is OpenAgent owned by OpenAI?](/help/faq/what-is-openclaw#is-openclaw-owned-by-openai)
- <a id="what-does-openclaw-send-to-the-foundation" />[What does OpenAgent send to the Foundation?](/help/faq/what-is-openclaw#what-does-openclaw-send-to-the-foundation)
- <a id="how-is-openclaw-funded-and-how-does-that-compare" />[How is OpenAgent funded, and how does that compare?](/help/faq/what-is-openclaw#how-is-openclaw-funded-and-how-does-that-compare)
...
- <a id="can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background" />[Can OpenAgent run tasks on a schedule or continuously in the background?](/help/faq/skills-and-automation#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- <a id="how-do-i-use-my-existing-signed-in-chrome-with-openclaw" />[How do I use my existing signed-in Chrome with OpenAgent?](/help/faq/skills-and-automation#how-do-i-use-my-existing-signed-in-chrome-with-openclaw)
...
- <a id="is-all-data-used-with-openclaw-saved-locally" />[Is all data used with OpenAgent saved locally?](/help/faq/where-things-live-on-disk#is-all-data-used-with-openclaw-saved-locally)
- <a id="where-does-openclaw-store-its-data" />[Where does OpenAgent store its data?](/help/faq/where-things-live-on-disk#where-does-openclaw-store-its-data)
...
- <a id="how-do-i-completely-uninstall-openclaw" />[How do I completely uninstall OpenAgent?](/help/faq/where-things-live-on-disk#how-do-i-completely-uninstall-openclaw)
...
- <a id="can-the-openclaw-browser-run-headless" />[Can the OpenAgent browser run headless?](/help/faq/config-basics#can-the-openclaw-browser-run-headless)
...
- <a id="can-two-openclaw-instances-talk-to-each-other-local-vps" />[Can two OpenAgent instances talk to each other (local + VPS)?](/help/faq/remote-gateways-and-nodes#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- <a id="is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents" />[Is there a way to make a team of OpenAgent instances (one CEO and many agents)?](/help/faq/sessions-and-chats#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
...
- <a id="how-do-i-completely-reset-openclaw-but-keep-it-installed" />[How do I completely reset OpenAgent but keep it installed?](/help/faq/sessions-and-chats#how-do-i-completely-reset-openclaw-but-keep-it-installed)
...
- <a id="i-closed-my-terminal-on-windows-how-do-i-restart-openclaw" />[I closed my terminal on Windows - how do I restart OpenAgent?](/help/faq/logging-and-debugging#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
...
- <a id="is-it-safe-to-expose-openclaw-to-inbound-dms" />[Is it safe to expose OpenAgent to inbound DMs?](/help/faq/security-and-access-control#is-it-safe-to-expose-openclaw-to-inbound-dms)
