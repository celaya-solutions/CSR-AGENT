---
summary: "Frequently asked questions about Zero to Agent setup, configuration, and usage"
read_when:
...
| Page                                                                                       | Read it when                                                                    |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [What is Zero to Agent?](/help/faq/what-is-openclaw)                                       | You are evaluating Zero to Agent, or explaining what it is and who funds it.    |
...
| [Where things live on disk](/help/faq/where-things-live-on-disk)                           | You need to find, back up, move, or remove Zero to Agent data.                  |
...
| [Security and access control](/help/faq/security-and-access-control)                       | You are exposing Zero to Agent to inbound messages or judging plugin risk.      |
...
- <a id="what-is-openclaw%3F" /><a id="what-is-openclaw" />[What is Zero to Agent?](/help/faq/what-is-openclaw#what-is-openclaw)
- <a id="what-is-openclaw-in-one-paragraph" />[What is Zero to Agent, in one paragraph?](/help/faq/what-is-openclaw#what-is-openclaw-in-one-paragraph)
- <a id="can-my-team-share-one-openclaw" />[Can my team share one Zero to Agent?](/help/faq/what-is-openclaw#can-my-team-share-one-openclaw)
...
- <a id="what-are-the-top-five-everyday-use-cases-for-openclaw" />[What are the top five everyday use cases for Zero to Agent?](/help/faq/what-is-openclaw#what-are-the-top-five-everyday-use-cases-for-openclaw)
- <a id="can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas" />[Can Zero to Agent help with lead gen, outreach, ads, and blogs for a SaaS?](/help/faq/what-is-openclaw#can-openclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
- <a id="is-openclaw-owned-by-openai" />[Is Zero to Agent owned by OpenAI?](/help/faq/what-is-openclaw#is-openclaw-owned-by-openai)
- <a id="what-does-openclaw-send-to-the-foundation" />[What does Zero to Agent send to the Foundation?](/help/faq/what-is-openclaw#what-does-openclaw-send-to-the-foundation)
- <a id="how-is-openclaw-funded-and-how-does-that-compare" />[How is Zero to Agent funded, and how does that compare?](/help/faq/what-is-openclaw#how-is-openclaw-funded-and-how-does-that-compare)
...
- <a id="can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background" />[Can Zero to Agent run tasks on a schedule or continuously in the background?](/help/faq/skills-and-automation#can-openclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- <a id="how-do-i-use-my-existing-signed-in-chrome-with-openclaw" />[How do I use my existing signed-in Chrome with Zero to Agent?](/help/faq/skills-and-automation#how-do-i-use-my-existing-signed-in-chrome-with-openclaw)
...
- <a id="is-all-data-used-with-openclaw-saved-locally" />[Is all data used with Zero to Agent saved locally?](/help/faq/where-things-live-on-disk#is-all-data-used-with-openclaw-saved-locally)
- <a id="where-does-openclaw-store-its-data" />[Where does Zero to Agent store its data?](/help/faq/where-things-live-on-disk#where-does-openclaw-store-its-data)
...
- <a id="how-do-i-completely-uninstall-openclaw" />[How do I completely uninstall Zero to Agent?](/help/faq/where-things-live-on-disk#how-do-i-completely-uninstall-openclaw)
...
- <a id="can-the-openclaw-browser-run-headless" />[Can the Zero to Agent browser run headless?](/help/faq/config-basics#can-the-openclaw-browser-run-headless)
...
- <a id="can-two-openclaw-instances-talk-to-each-other-local-vps" />[Can two Zero to Agent instances talk to each other (local + VPS)?](/help/faq/remote-gateways-and-nodes#can-two-openclaw-instances-talk-to-each-other-local-vps)
...
- <a id="how-does-openclaw-load-environment-variables" />[How does Zero to Agent load environment variables?](/help/faq/env-vars#how-does-openclaw-load-environment-variables)
...
- <a id="is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents" />[Is there a way to make a team of Zero to Agent instances (one CEO and many agents)?](/help/faq/sessions-and-chats#is-there-a-way-to-make-a-team-of-openclaw-instances-one-ceo-and-many-agents)
...
- <a id="how-do-i-completely-reset-openclaw-but-keep-it-installed" />[How do I completely reset Zero to Agent but keep it installed?](/help/faq/sessions-and-chats#how-do-i-completely-reset-openclaw-but-keep-it-installed)
...
- <a id="why-does-openclaw-not-reply-in-a-group" />[Why does Zero to Agent not reply in a group?](/help/faq/sessions-and-chats#why-does-openclaw-not-reply-in-a-group)
...
- <a id="how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere" />[How do I run Zero to Agent in remote mode (client connects to a Gateway elsewhere)?](/help/faq/gateway-ports-and-remote-mode#how-do-i-run-openclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- <a id="i-closed-my-terminal-on-windows-how-do-i-restart-openclaw" />[I closed my terminal on Windows - how do I restart Zero to Agent?](/help/faq/logging-and-debugging#i-closed-my-terminal-on-windows-how-do-i-restart-openclaw)
...
- <a id="is-it-safe-to-expose-openclaw-to-inbound-dms" />[Is it safe to expose Zero to Agent to inbound DMs?](/help/faq/security-and-access-control#is-it-safe-to-expose-openclaw-to-inbound-dms)
...
- <a id="is-openclaw-less-safe-because-it-uses-typescript-node-instead-of-rust-wasm" />[Is Zero to Agent less safe because it uses TypeScript/Node instead of Rust/WASM?](/help/faq/security-and-access-control#is-openclaw-less-safe-because-it-uses-typescript-node-instead-of-rust-wasm)
- <a id="i-saw-reports-about-exposed-openclaw-instances-what-should-i-check" />[I saw reports about exposed Zero to Agent instances. What should I check?](/help/faq/security-and-access-control#i-saw-reports-about-exposed-openclaw-instances-what-should-i-check)
