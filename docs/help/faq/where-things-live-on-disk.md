...
read_when:
  - You need to find, back up, or move Zero to Agent data
...
<AccordionGroup>
  <Accordion title="Is all data used with Zero to Agent saved locally?">
    No: **Zero to Agent's own state is local**, but **external services still see what you send them**.
  ...
  <Accordion title="Where does Zero to Agent store its data?">
