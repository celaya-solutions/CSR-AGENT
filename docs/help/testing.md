---
summary: "Index of the Zero to Agent testing kit, one page per reader job"
read_when:
...
Zero to Agent has three Vitest suites (unit/integration, e2e, live) plus Docker
...
- [CI](/ci)
- [Zero to Agent agent runtime workflow](/openclaw-agent-runtime) - the build, test, and live-validation loop for agent runtime code in `src/agents/`
