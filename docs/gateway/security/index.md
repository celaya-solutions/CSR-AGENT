...
<Note>
  **One trust boundary per gateway.** This guidance assumes one trusted
  ...
  are supported deployments inside that boundary. Zero to Agent is not a hostile
