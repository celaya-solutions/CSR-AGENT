---
summary: "Trust model, safe defaults, and hardening guidance for running OpenAgent"
read_when:
  - Adding features that widen access or automation
  - Reviewing OpenAgent security posture or hardening a deployment
title: "Security"
---
...
<Note>
  **One trust boundary per gateway.** This guidance assumes one trusted
  ...
  are supported deployments inside that boundary. OpenAgent is not a hostile
