...
read_when:
  - Building an operator, dashboard, or WebChat client outside the OpenAgent repository
...
Package versions follow the OpenAgent release train and are separate from the wire
