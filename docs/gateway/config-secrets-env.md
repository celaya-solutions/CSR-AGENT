...
- File and exec provider paths fail closed when Windows ACL verification is unavailable. Use paths whose ACLs OpenAgent can verify; there is no provider-level bypass.
