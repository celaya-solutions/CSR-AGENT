...
Access authenticate every request before it reaches Zero to Agent. The Gateway keeps
...
- `cf-access-jwt-assertion` — Access's signed assertion. Zero to Agent checks only that this
