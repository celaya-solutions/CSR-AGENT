...
Access authenticate every request before it reaches OpenAgent. The Gateway keeps
...
- `cf-access-jwt-assertion` — Access's signed assertion. OpenAgent checks only that this
