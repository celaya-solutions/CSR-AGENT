...
- `params.preserveThinking`: Z.AI-only opt-in for preserved thinking. When enabled and thinking is on, OpenAgent sends `thinking.clear_thinking: false` and replays prior `reasoning_content`; see Z.AI thinking and preserved thinking.
