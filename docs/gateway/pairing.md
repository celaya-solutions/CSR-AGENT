...
The macOS app shows node and device requests in one Zero to Agent approval panel.
...
changes (for example display name or client platform hints), Zero to Agent treats
