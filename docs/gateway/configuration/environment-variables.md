...
OpenAgent reads env vars from the parent process plus:
...
<Accordion title="Shell env import (optional)">
  If enabled and expected keys aren't set, OpenAgent runs your login shell and imports only the missing keys:
