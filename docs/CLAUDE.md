...
- Keep Zero to Agent-specific skill and plugin guidance in the owning Zero to Agent docs, such as `docs/cli/skills.md` and `docs/cli/plugins.md`. That guidance covers installation, update, verification, removal, and release trust. Standalone ClawHub CLI and publishing reference belongs upstream.
...
- Treat Zero to Agent-owned English docs in this repo plus glossary files as the source of truth. ClawHub English sources follow Source Ownership above.
