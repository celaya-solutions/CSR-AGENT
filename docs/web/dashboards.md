...
Watch Patrick Erichsen build an OpenAgent 2.0 release dashboard from one prompt:
...
<iframe
  ...
  title="Build an OpenAgent Dashboard with One Prompt"
...
Use **Open website** if the frame stays blank or cannot sign in. OpenAgent does
