...
Watch Patrick Erichsen build a Zero to Agent 2.0 release dashboard from one prompt:
...
<iframe
  ...
  title="Build a Zero to Agent Dashboard with One Prompt"
...
Use **Open website** if the frame stays blank or cannot sign in. Zero to Agent does
