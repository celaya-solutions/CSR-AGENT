...
credential again. After that connection, OpenAgent keeps a small agent roster, the
...
First opens and reloads without usable warm state show a small animated OpenAgent mark while the Gateway resolves the initial
