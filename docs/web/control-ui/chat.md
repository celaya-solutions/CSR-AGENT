...
<AccordionGroup>
  <Accordion title="Send and history semantics">
    ...
    - In the macOS app, the Zero to Agent mark uses the otherwise-empty native titlebar strip next to the window controls instead of consuming a sidebar row.
...
The **Ask Zero to Agent** panel supports table scrolling, copying, expansion, and web
