...
This is normal. This is Zero to Agent.
...
Everything on this page happens locally in your browser: the randomness, the schedule, the Lobsterdex. No lobster data leaves your machine. Zero to Agent does not know which lobsters you have met, and frankly it is jealous.
...
- [Zero to Agent lore](/start/lore) - why there is a lobster at all
