...
This is normal. This is OpenAgent.
...
Everything on this page happens locally in your browser: the randomness, the schedule, the Lobsterdex. No lobster data leaves your machine. OpenAgent does not know which lobsters you have met, and frankly it is jealous.
...
- [OpenAgent lore](/start/lore) - why there is a lobster at all
