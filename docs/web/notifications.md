...
- **This browser or app** can mute one browser profile or installed Home Screen app. It can also add a source label or override individual categories. The account defaults stay unchanged. Native OpenAgent app notifications are configured separately.
