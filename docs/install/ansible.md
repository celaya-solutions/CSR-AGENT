---
summary: "Automated, hardened OpenAgent installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
Deploy OpenAgent to production servers with **[openclaw-ansible](https://github.com/openclaw/openclaw-ansible)**, an automated installer with a security-first architecture.
...
4. Node.js and pnpm (OpenAgent requires Node 24.16+ or 26.1+; Node 26 is recommended)
5. OpenAgent, installed host-based, not containerized
...
<Steps>
  ...
  <Step title="Run the onboarding wizard">
    The post-install script guides you through configuring OpenAgent.
  </Step>
...
The Ansible installer sets up OpenAgent for manual updates; see [Updating](/install/updating) for the standard flow.
