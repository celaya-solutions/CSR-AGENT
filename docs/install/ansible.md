---
summary: "Automated, hardened Zero to Agent installation with Ansible, Tailscale VPN, and firewall isolation"
read_when:
...
Deploy Zero to Agent to production servers with **[openclaw-ansible](https://github.com/openclaw/openclaw-ansible)**, an automated installer with a security-first architecture.
...
4. Node.js and pnpm (Zero to Agent requires Node 24.16+ or 26.1+; Node 26 is recommended)
5. Zero to Agent, installed host-based, not containerized
...
<Steps>
  ...
  <Step title="Run the onboarding wizard">
    The post-install script guides you through configuring Zero to Agent.
  </Step>
...
The Ansible installer sets up Zero to Agent for manual updates; see [Updating](/install/updating) for the standard flow.
