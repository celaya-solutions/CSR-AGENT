---
summary: "Host OpenAgent on Upstash Box with keep-alive and SSH tunnel access"
read_when:
  - Deploying OpenAgent to Upstash Box
  - You want a managed Linux environment for OpenAgent with SSH-tunneled dashboard access
title: "Upstash Box"
---

Run a persistent OpenAgent Gateway on Upstash Box, a managed Linux environment
...
Upstash maintains its current OpenAgent Box walkthrough at
[OpenAgent Setup](https://upstash.com/docs/box/guides/openclaw-setup).

## Connect with an SSH tunnel

Forward the OpenAgent dashboard port to your local machine. Use your Box API key
