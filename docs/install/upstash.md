---
summary: "Host Zero to Agent on Upstash Box with keep-alive and SSH tunnel access"
read_when:
  - Deploying Zero to Agent to Upstash Box
  - You want a managed Linux environment for Zero to Agent with SSH-tunneled dashboard access
title: "Upstash Box"
---

Run a persistent Zero to Agent Gateway on Upstash Box, a managed Linux environment
...
Upstash maintains its current Zero to Agent Box walkthrough at
[Zero to Agent Setup](https://upstash.com/docs/box/guides/openclaw-setup).

## Connect with an SSH tunnel

Forward the Zero to Agent dashboard port to your local machine. Use your Box API key
