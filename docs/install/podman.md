---
summary: "Run OpenAgent in a rootless Podman container"
read_when:
  - You want a containerized gateway with Podman instead of Docker
title: "Podman"
---

Run the OpenAgent Gateway in a rootless Podman container, managed by your current non-root user.
...
- **OpenAgent CLI** installed on the host
...
<Steps>
  ...
  <Step title="Start the Gateway container">
    ...
    Starts the container as your current uid/gid with `--userns=keep-id` and bind-mounts your OpenAgent state into the container.
...
After you rebuild the image, restart the container or Quadlet service.
On first startup for a new OpenAgent version, the gateway runs safe state and
