---
summary: "Run Zero to Agent in a rootless Podman container"
read_when:
  - You want a containerized gateway with Podman instead of Docker
title: "Podman"
---

Run the Zero to Agent Gateway in a rootless Podman container, managed by your current non-root user.
...
- **Zero to Agent CLI** installed on the host
...
<Steps>
  ...
  <Step title="Start the Gateway container">
    ...
    Starts the container as your current uid/gid with `--userns=keep-id` and bind-mounts your Zero to Agent state into the container.
...
On first startup for a new Zero to Agent version, the gateway runs safe state and
