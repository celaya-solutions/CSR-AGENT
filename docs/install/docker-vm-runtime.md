---
summary: "Shared Docker VM runtime steps for long-lived OpenAgent Gateway hosts"
doc-schema-version: 1
read_when:
  - You are deploying OpenAgent on a cloud VM with Docker
...
OpenAgent runs in Docker, but the container filesystem is not the source of
...
A single-file bind remains attached to the mounted file. Normal OpenAgent
