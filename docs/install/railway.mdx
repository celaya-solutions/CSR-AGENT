---
summary: "Deploy OpenAgent on Railway with one-click template"
read_when:
  - Deploying OpenAgent to Railway
  - You want a one-click cloud deploy with browser-based Control UI
title: "Railway"
---

Deploy OpenAgent on Railway with a one-click template and access it through the web Control UI. This is the easiest "no terminal on the server" path: Railway runs the Gateway for you.
