---
summary: "Host Zero to Agent on Oracle Cloud's Always Free ARM tier"
read_when:
  - Setting up Zero to Agent on Oracle Cloud
  - Looking for free VPS hosting for Zero to Agent
  - Want 24/7 Zero to Agent on a small server
title: "Oracle Cloud"
---

Run a persistent Zero to Agent Gateway on Oracle Cloud's **Always Free** ARM tier (up to 4 OCPU, 24 GB RAM, 200 GB storage) at no cost.
...
- `openclaw security audit` for a Zero to Agent-specific posture check.
...
The Always Free tier is ARM (`aarch64`). Most Zero to Agent features work fine; a small number of native binaries need ARM builds:
