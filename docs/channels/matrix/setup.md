...
read_when:
  - Setting up Matrix in Zero to Agent for the first time
...
```json5
{
  channels: {
    matrix: {
      ...
      deviceName: "Zero to Agent Gateway",
    },
  },
}
```
