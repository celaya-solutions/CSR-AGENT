---
summary: "How OpenAgent upgrades the previous Matrix plugin in place, including encrypted-state recovery limits and manual recovery steps."
read_when:
...
into the root OpenAgent package.
...
## Upgrading from OpenAgent releases older than 2026.4
...
1. Update OpenAgent and the Matrix plugin normally.
2. Run:
...
6. If OpenAgent tells you a recovery key is needed, run the command for the matching account:
