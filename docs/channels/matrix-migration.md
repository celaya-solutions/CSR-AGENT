---
summary: "How Zero to Agent upgrades the previous Matrix plugin in place, including encrypted-state recovery limits and manual recovery steps."
read_when:
...
into the root Zero to Agent package.
...
## Upgrading from Zero to Agent releases older than 2026.4
...
1. Update Zero to Agent and the Matrix plugin normally.
2. Run:
...
6. If Zero to Agent tells you a recovery key is needed, run the command for the matching account:
