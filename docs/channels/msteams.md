...
- <a id="step-6%3A-configure-openclaw" />[Step 6: Configure Zero to Agent](/channels/msteams/setup#step-6%3A-configure-openclaw)
- <a id="step-6-configure-openclaw" />[Step 6: Configure Zero to Agent](/channels/msteams/setup#step-6-configure-openclaw)
