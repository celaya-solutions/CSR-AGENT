...
read_when:
  - You want OpenAgent to receive DMs via Nostr
  - You're setting up decentralized messaging
title: "Nostr"
---

Nostr is a downloadable channel plugin (`@openclaw/nostr`) that lets OpenAgent receive and answer NIP-04 encrypted direct messages over Nostr relays. One account per gateway; DMs only.
