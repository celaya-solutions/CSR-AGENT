...
How Discord threads, forums, and channels map onto Zero to Agent sessions.

## Forum channels

Discord forum and media channels only accept thread posts. Zero to Agent supports two ways to create them:
