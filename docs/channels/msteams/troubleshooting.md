...
Teams delivers messages via HTTP webhook. Zero to Agent applies fixed HTTP server
...
| Teams environment | Zero to Agent config                                        | Proactive `serviceUrl`                             |
| ----------------- | ----------------------------------------------------------- | -------------------------------------------------- |
