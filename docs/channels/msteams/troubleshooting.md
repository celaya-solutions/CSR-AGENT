...
Teams delivers messages via HTTP webhook. OpenAgent applies fixed HTTP server
...
| Teams environment | OpenAgent config                                        | Proactive `serviceUrl`                             |
| ----------------- | ----------------------------------------------------------- | -------------------------------------------------- |
