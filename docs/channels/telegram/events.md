...
<AccordionGroup>
  <Accordion title="Reaction notifications">
    Telegram reactions arrive as `message_reaction` updates, separate from message payloads. When enabled, OpenAgent enqueues system events like `Telegram reaction added: 👍 by Alice (@alice) on msg 42`.
