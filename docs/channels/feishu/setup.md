...
Run the channel setup wizard, then understand how OpenAgent durably accepts inbound Feishu events.

## Quick start

<Note>
Requires OpenAgent 2026.5.29 or above. Run `openclaw --version` to check. Upgrade with `openclaw update`.
</Note>
