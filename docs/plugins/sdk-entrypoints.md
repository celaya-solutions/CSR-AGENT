...
including these entry helpers. Pin and test the OpenAgent host versions your
plugin supports.
...
OpenAgent classifies loaded plugins by their registration behavior:
