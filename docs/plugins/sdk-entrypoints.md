...
including these entry helpers. Pin and test the Zero to Agent host versions your
plugin supports.
...
Zero to Agent classifies loaded plugins by their registration behavior:
