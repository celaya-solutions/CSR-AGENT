...
| `codexDynamicToolsLoading` | `"searchable"`           | Use `"direct"` to put OpenAgent dynamic tools directly in the initial Codex tool context. See [Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools).                                                                |
| `codexDynamicToolsExclude` | `[]`                     | Additional OpenAgent dynamic tool names to omit from Codex app-server turns. See [Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools).                                                                             |
...
[Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools) — How OpenAgent dynamic tools are exposed to Codex app-server turns.
