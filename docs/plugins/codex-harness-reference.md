...
| `codexDynamicToolsLoading` | `"searchable"`           | Use `"direct"` to put Zero to Agent dynamic tools directly in the initial Codex tool context. See [Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools).                                                                |
| `codexDynamicToolsExclude` | `[]`                     | Additional Zero to Agent dynamic tool names to omit from Codex app-server turns. See [Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools).                                                                             |
...
[Codex dynamic tools](/plugins/codex-harness-reference/dynamic-tools) — How Zero to Agent dynamic tools are exposed to Codex app-server turns.
