---
summary: "Step-by-step guide to building a messaging channel plugin for OpenAgent"
title: "Building channel plugins"
sidebarTitle: "Channel Plugins"
read_when:
  - You are building a new messaging channel plugin
  - You want to connect OpenAgent to a messaging platform
  - You need to understand the ChannelPlugin adapter surface
---

This guide builds a channel plugin that connects OpenAgent to a messaging
...
<Steps>
    ...
    ```json package.json
    {
      ...
      "openclaw": {
        ...
        "channel": {
          "id": "acme-chat",
          "label": "Acme Chat",
          "blurb": "Connect OpenAgent to Acme Chat."
        }
      }
    }
    ```
  ...
  <Step title="Build the channel plugin object">
    ...
    OpenAgent sets this mode only for trusted non-ingress execution whose sender
  ...
  <Step title="Wire the entry point">
    ...
    Put channel-owned CLI descriptors in `registerCliMetadata(...)` so OpenAgent
  ...
  <Step title="Add a setup entry">
    ...
    OpenAgent loads this instead of the full entry when the channel is disabled
  ...
  <Step title="Handle inbound messages">
    ...
    OpenAgent. The typical pattern is a webhook that verifies the request and
    ...
    registerFull(api) {
      api.registerHttpRoute({
        ...
        handler: async (req, res) => {
          ...
          // Your inbound handler dispatches the message to OpenAgent.
