...
plugin trust boundary; OpenAgent does not treat installed plugins as mutually
...
normal OpenAgent plugin hooks for work that does not need pre-model tool-result
timing. The old
