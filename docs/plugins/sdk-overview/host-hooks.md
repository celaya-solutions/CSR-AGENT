...
plugin trust boundary; Zero to Agent does not treat installed plugins as mutually
...
normal Zero to Agent plugin hooks for work that does not need pre-model tool-result
timing. The old
