...
read_when:
  - You want a Zero to Agent agent to join a Zoom meeting
...
Zero to Agent Chrome profile. It does not create meetings, dial in, use the Zoom
...
same Zero to Agent Chrome profile, then retry status or speech. It does not bypass
Zoom policy.
