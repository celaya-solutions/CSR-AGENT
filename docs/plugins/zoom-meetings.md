...
read_when:
  - You want an OpenAgent agent to join a Zoom meeting
...
OpenAgent Chrome profile. It does not create meetings, dial in, use the Zoom
...
same OpenAgent Chrome profile, then retry status or speech. It does not bypass
Zoom policy.
