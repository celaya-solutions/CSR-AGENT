...
read_when:
  - You used api.registerEmbeddedExtensionFactory before OpenAgent 2026.4.25
  - You are updating a plugin to the modern plugin architecture
  - You maintain an external OpenAgent plugin
---

OpenAgent replaced a broad backwards-compatibility layer with a modern plugin
...
OpenAgent does not remove or reinterpret documented plugin behavior in the same
