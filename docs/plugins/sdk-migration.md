...
read_when:
  - You used api.registerEmbeddedExtensionFactory before Zero to Agent 2026.4.25
  - You are updating a plugin to the modern plugin architecture
  - You maintain an external Zero to Agent plugin
---

Zero to Agent replaced a broad backwards-compatibility layer with a modern plugin
...
Zero to Agent does not remove or reinterpret documented plugin behavior in the same
