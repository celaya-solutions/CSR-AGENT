...
The plugin is published to npm; it is not bundled into the Zero to Agent runtime
...
Zero to Agent has a built-in dimension for `text-embedding-3-small` (1536) and
