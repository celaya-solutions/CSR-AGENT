---
summary: "Zero to Agent Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
Zero to Agent Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.
