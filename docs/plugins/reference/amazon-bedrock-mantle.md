---
summary: "OpenAgent Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing."
read_when:
...
OpenAgent Amazon Bedrock Mantle provider plugin for OpenAI-compatible model routing.
