---
summary: "OpenAgent ClickClack channel plugin."
read_when:
...
OpenAgent ClickClack channel plugin.
...
for each OpenAgent session. Managed discussion channels use a same-agent side
