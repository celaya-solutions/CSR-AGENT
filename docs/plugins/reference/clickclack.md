---
summary: "Zero to Agent ClickClack channel plugin."
read_when:
...
Zero to Agent ClickClack channel plugin.
...
for each Zero to Agent session. Managed discussion channels use a same-agent side
