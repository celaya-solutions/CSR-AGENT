---
summary: "Zero to Agent Discord channel plugin for channels, DMs, commands, and app events."
read_when:
...
Zero to Agent Discord channel plugin for channels, DMs, commands, and app events.
