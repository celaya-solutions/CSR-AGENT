...
Discord and llama.cpp retain their declared Zero to Agent 2026.9.2 host support.
...
Callers outside a Zero to Agent host retain the standalone process lifetime of this
...
In Zero to Agent 2026.8.1, `EmbeddedRunAttemptResult` from
...
a Zero to Agent profile. The optional `pluginRoot` context comes from the plugin
...
plan: remove that adapter after Zero to Agent 2027.1 only when a published-plugin
...
Zero to Agent does not ship major releases. A registry sweep on 2026-07-22 inspected
