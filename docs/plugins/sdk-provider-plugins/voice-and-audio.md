...
<Tabs>
  ...
  <Tab title="Realtime voice">
    ...
    honor `options.suppressResponse`. OpenAgent then avoids suppression for
    ...
    flag use OpenAgent's local input-audio fallback detection.
  ...
  <Tab title="Media understanding">
    ...
    **before uploading audio**. The host records that error and automatic
    ...
    Applicable ambient HTTP(S) proxies and OpenAgent-managed proxies retain
    ...
    OpenAgent still keeps the normal auth gate for providers that do not
