...
When a setup-time flow installs a plugin whose id appears in the map, OpenAgent
...
- Overrides do not inherit official trusted-source status. Even when the
  catalog entry normally represents an OpenAgent-owned package, an override is
