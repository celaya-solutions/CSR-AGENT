...
<Note>
  ...
  Zero to Agent. For external apps, scripts, dashboards, CI jobs, and IDE extensions
...
All Zero to Agent plugin APIs are **experimental**. This includes every
...
change between Zero to Agent releases.

Pin the Zero to Agent version used to develop and deploy your plugin, and test each
