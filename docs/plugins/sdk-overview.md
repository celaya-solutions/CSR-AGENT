...
<Note>
  ...
  OpenAgent. For external apps, scripts, dashboards, CI jobs, and IDE extensions
...
All OpenAgent plugin APIs are **experimental**. This includes every
...
change between OpenAgent releases.

Pin the OpenAgent version used to develop and deploy your plugin, and test each
