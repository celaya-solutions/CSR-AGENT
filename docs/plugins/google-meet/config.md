...
The common Chrome agent path only needs the plugin enabled, BlackHole, SoX, a realtime provider key, and a configured OpenAgent TTS provider:
...
| `chrome.guestName`                | `"OpenAgent Agent"`                  | Shown on the signed-out Meet guest screen                                                                                                                                                                                                        |
...
| `realtime.agentId`                | `"main"`                                 | OpenAgent agent id used for function-tool consults and native Live delegation.                                                                                                                                                               |
...
transcription and regular OpenAgent TTS; changing the realtime voice model does
