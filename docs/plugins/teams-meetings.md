...
read_when:
  - You want a Zero to Agent agent to join a Microsoft Teams meeting
...
`teams.live.com/meet/...` as a guest in the Zero to Agent Chrome profile. It does not
...
`manualAction`. Complete the requested step in the same Zero to Agent Chrome profile,
