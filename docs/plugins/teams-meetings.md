...
read_when:
  - You want an OpenAgent agent to join a Microsoft Teams meeting
...
`teams.live.com/meet/...` as a guest in the OpenAgent Chrome profile. It does not
...
`manualAction`. Complete the requested step in the same OpenAgent Chrome profile,
