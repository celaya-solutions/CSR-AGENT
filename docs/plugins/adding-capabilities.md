---
summary: "Contributor guide for adding a new shared capability to the Zero to Agent plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Zero to Agent core developers. If you are
...
Use this when Zero to Agent needs a new shared domain such as embeddings, image
