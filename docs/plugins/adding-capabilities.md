---
summary: "Contributor guide for adding a new shared capability to the OpenAgent plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for OpenAgent core developers. If you are
...
Use this when OpenAgent needs a new shared domain such as embeddings, image
