...
OpenAgent sends one neutral receipt when it launches a real task; status and
...
OpenAgent preserves the answer rather than guessing that the spoken text replaces it.
