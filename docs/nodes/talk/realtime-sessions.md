...
Zero to Agent sends one neutral receipt when it launches a real task; status and
...
Zero to Agent preserves the answer rather than guessing that the spoken text replaces it.
