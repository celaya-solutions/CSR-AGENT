...
- [Host Zero to Agent sessions on a node](/nodes/session-hosting) - Worker session hosting, device placement, capacity, and container isolation.
...
- <a id="openclaw-sessions-and-transcripts" />[Zero to Agent sessions and transcripts](/nodes/session-catalogs#openclaw-sessions-and-transcripts)

**[Host Zero to Agent sessions on a node](/nodes/session-hosting)**

- <a id="host-openclaw-sessions" />[Host Zero to Agent sessions](/nodes/session-hosting#host-openclaw-sessions)
