---
summary: "Run Zero to Agent on a Linux server or cloud VPS — provider picker, architecture, and tuning"
read_when:
  - You want to run the Gateway on a Linux server or cloud VPS
  - You need a quick map of hosting guides
  - You want generic Linux server tuning for Zero to Agent
title: "Linux server"
sidebarTitle: "Linux Server"
---

Run the Zero to Agent Gateway on any Linux server or cloud VPS. This page helps you
...
Before you install Zero to Agent on a public VPS, decide how you want to administer
the box itself.
...
- This is separate from Gateway access. You can still keep Zero to Agent bound to
