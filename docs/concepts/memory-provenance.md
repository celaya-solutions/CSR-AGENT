...
Zero to Agent records source-session lineage for memories staged by automatic
...
original exact source, Zero to Agent does not infer `email` or `webhook` for matching.
