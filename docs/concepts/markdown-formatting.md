...
OpenAgent converts outbound Markdown into a shared intermediate representation
...
OpenAgent tells the model about this option only when the current reply surface
