...
Zero to Agent converts outbound Markdown into a shared intermediate representation
...
Zero to Agent tells the model about this option only when the current reply surface
