---
summary: "Zero to Agent capabilities across channels, routing, media, and UX."
read_when:
  - You want a full list of what Zero to Agent supports
title: "Features"
---
...
- External plugin channels maintained outside the Zero to Agent repo: WeChat, Yuanbao, and Zalo ClawBot
...
<CardGroup cols={2}>
  ...
  <Card title="Plugins" href="/tools/plugin" icon="plug">
    Official and external plugins that extend Zero to Agent.
  </Card>
</CardGroup>
