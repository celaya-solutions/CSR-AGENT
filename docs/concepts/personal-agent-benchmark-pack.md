...
Running the pack needs a source checkout of the Zero to Agent repository — `pnpm
...
write real Zero to Agent user memory, sessions, credentials, launch agents, global
