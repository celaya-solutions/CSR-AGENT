...
- `mock-openai` is the scenario-aware Zero to Agent mock. It remains the default
...
runs Zero to Agent's normal channel plugins against their provider-shaped REST and
