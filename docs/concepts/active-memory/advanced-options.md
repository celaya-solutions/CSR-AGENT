...
store. By default, OpenAgent removes the temporary sub-agent session rows after
...
Exported transcript artifacts go under the OpenAgent state directory, in a
