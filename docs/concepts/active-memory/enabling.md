...
enabled, Zero to Agent indexes that agent's session transcripts and runs an Active
...
Zero to Agent's built-in memory provider supports this protected transcript-recall
