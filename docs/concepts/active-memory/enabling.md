...
enabled, OpenAgent indexes that agent's session transcripts and runs an Active
...
OpenAgent's built-in memory provider supports this protected transcript-recall
