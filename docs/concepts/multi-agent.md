...
If you configure nothing, OpenAgent runs one agent:
...
OpenAgent records how each configured agent was created: `operator` for CLI,
...
requesting agent id. A configured agent can ask OpenAgent to create another
