...
| ------------- | -------------------------------------------- | ------------------------------------------------------------------------ |
| Provider      | `anthropic`, `github-copilot`, `openai`      | How OpenAgent authenticates, discovers models, and names model refs. |
...
| Channel       | Discord, Slack, Telegram, WhatsApp           | Where messages enter and leave OpenAgent.                            |
