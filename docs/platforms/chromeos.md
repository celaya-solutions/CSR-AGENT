---
summary: "Run the OpenAgent Gateway on ChromeOS inside a Crostini Linux container"
read_when:
  - Installing OpenAgent on a Chromebook or ChromeOS device
...
The Node version available in a Crostini container may be below OpenAgent's
minimum. OpenAgent requires Node 24.16+ or Node 26.1+; Node 26
...
If you installed Node yourself before OpenAgent, upgrade it **before** installing
OpenAgent:
