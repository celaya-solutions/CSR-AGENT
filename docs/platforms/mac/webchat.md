...
or `bash`, after `./scripts/package-mac-app.sh` has produced `dist/OpenAgent.app`.

- Manual: Lobster menu -> "Open Chat".
- Auto-open for testing:

  ```bash
  dist/OpenAgent.app/Contents/MacOS/OpenClaw --chat
  ```
