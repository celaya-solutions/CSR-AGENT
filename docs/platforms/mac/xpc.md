---
summary: "macOS IPC architecture for Zero to Agent app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# Zero to Agent macOS IPC architecture
...
- UI automation uses a separate UNIX socket (`~/Library/Application Support/Zero to Agent/<socket>`) and the PeekabooBridge JSON protocol.
- Host preference order (client-side): Peekaboo.app -> Claude.app -> Zero to Agent.app -> local execution.
