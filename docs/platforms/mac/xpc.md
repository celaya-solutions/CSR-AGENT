---
summary: "macOS IPC architecture for OpenAgent app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# OpenAgent macOS IPC architecture
...
- UI automation uses a separate UNIX socket (`~/Library/Application Support/OpenAgent/<socket>`) and the PeekabooBridge JSON protocol.
- Host preference order (client-side): Peekaboo.app -> Claude.app -> OpenAgent.app -> local execution.
