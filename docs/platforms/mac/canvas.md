...
`presentation.target: "node_panel"`. Zero to Agent stores the widget as a hosted
...
The result identifies the selected Mac when presentation succeeds. Zero to Agent
