...
- **About OpenAgent** opens the standard macOS About panel with version, build information, and credits.
...
- Source: `WorkActivityStore` (`apps/macos/Sources/OpenAgent/WorkActivityStore.swift`).
...
- With two or more Gateways, the connection label appends the primary Gateway's catalog display name, such as `OpenAgent Active — Mac Studio`.
