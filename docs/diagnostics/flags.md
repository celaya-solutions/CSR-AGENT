...
See [Environment variables](/help/environment) for where Zero to Agent reads
...
are missing because Zero to Agent has not read config yet; subsequent startup spans
